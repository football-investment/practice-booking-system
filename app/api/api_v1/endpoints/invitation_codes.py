...
from ....dependencies import get_current_admin_user_web, get_current_user_web, get_current_admin_user
...
async def create_invitation_code(
    ...
    db: Session = Depends(get_db),
    current_user: User = Depends(get_current_admin_user_web)  # Cookie-based web auth
) -> Any:
    """
    Create a new invitation code (Admin only)
    Uses cookie-based authentication for web interface
    """

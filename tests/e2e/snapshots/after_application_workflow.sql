...
\restrict 3liFrWc1qgPQ7AzNvh8HsZlV3Y10TMk09SpgFjR5SRRIj2OS0tqzT4iC7RRjK3L
...
ALTER TABLE IF EXISTS ONLY public.users DROP CONSTRAINT IF EXISTS users_payment_verified_by_fkey;
ALTER TABLE IF EXISTS ONLY public.users DROP CONSTRAINT IF EXISTS users_created_by_fkey;
ALTER TABLE IF EXISTS ONLY public.user_track_progresses DROP CONSTRAINT IF EXISTS user_track_progresses_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.user_track_progresses DROP CONSTRAINT IF EXISTS user_track_progresses_track_id_fkey;
ALTER TABLE IF EXISTS ONLY public.user_track_progresses DROP CONSTRAINT IF EXISTS user_track_progresses_certificate_id_fkey;
ALTER TABLE IF EXISTS ONLY public.user_stats DROP CONSTRAINT IF EXISTS user_stats_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.user_question_performance DROP CONSTRAINT IF EXISTS user_question_performance_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.user_question_performance DROP CONSTRAINT IF EXISTS user_question_performance_question_id_fkey;
ALTER TABLE IF EXISTS ONLY public.user_module_progresses DROP CONSTRAINT IF EXISTS user_module_progresses_user_track_progress_id_fkey;
ALTER TABLE IF EXISTS ONLY public.user_module_progresses DROP CONSTRAINT IF EXISTS user_module_progresses_module_id_fkey;
ALTER TABLE IF EXISTS ONLY public.user_licenses DROP CONSTRAINT IF EXISTS user_licenses_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.user_licenses DROP CONSTRAINT IF EXISTS user_licenses_skills_updated_by_fkey;
ALTER TABLE IF EXISTS ONLY public.user_licenses DROP CONSTRAINT IF EXISTS user_licenses_motivation_assessed_by_fkey;
ALTER TABLE IF EXISTS ONLY public.user_achievements DROP CONSTRAINT IF EXISTS user_achievements_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.user_achievements DROP CONSTRAINT IF EXISTS user_achievements_specialization_id_fkey;
ALTER TABLE IF EXISTS ONLY public.user_achievements DROP CONSTRAINT IF EXISTS user_achievements_achievement_id_fkey;
ALTER TABLE IF EXISTS ONLY public.tournament_team_enrollments DROP CONSTRAINT IF EXISTS tournament_team_enrollments_team_id_fkey;
ALTER TABLE IF EXISTS ONLY public.tournament_team_enrollments DROP CONSTRAINT IF EXISTS tournament_team_enrollments_semester_id_fkey;
ALTER TABLE IF EXISTS ONLY public.tournament_status_history DROP CONSTRAINT IF EXISTS tournament_status_history_tournament_id_fkey;
ALTER TABLE IF EXISTS ONLY public.tournament_status_history DROP CONSTRAINT IF EXISTS tournament_status_history_changed_by_fkey;
ALTER TABLE IF EXISTS ONLY public.tournament_stats DROP CONSTRAINT IF EXISTS tournament_stats_tournament_id_fkey;
ALTER TABLE IF EXISTS ONLY public.tournament_rewards DROP CONSTRAINT IF EXISTS tournament_rewards_tournament_id_fkey;
ALTER TABLE IF EXISTS ONLY public.tournament_rankings DROP CONSTRAINT IF EXISTS tournament_rankings_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.tournament_rankings DROP CONSTRAINT IF EXISTS tournament_rankings_tournament_id_fkey;
ALTER TABLE IF EXISTS ONLY public.tournament_rankings DROP CONSTRAINT IF EXISTS tournament_rankings_team_id_fkey;
ALTER TABLE IF EXISTS ONLY public.teams DROP CONSTRAINT IF EXISTS teams_captain_user_id_fkey;
...
ALTER TABLE IF EXISTS ONLY public.student_performance_reviews DROP CONSTRAINT IF EXISTS student_performance_reviews_student_id_fkey;
ALTER TABLE IF EXISTS ONLY public.student_performance_reviews DROP CONSTRAINT IF EXISTS student_performance_reviews_session_id_fkey;
ALTER TABLE IF EXISTS ONLY public.student_performance_reviews DROP CONSTRAINT IF EXISTS student_performance_reviews_instructor_id_fkey;
ALTER TABLE IF EXISTS ONLY public.specialization_progress DROP CONSTRAINT IF EXISTS specialization_progress_student_id_fkey;
ALTER TABLE IF EXISTS ONLY public.specialization_progress DROP CONSTRAINT IF EXISTS specialization_progress_specialization_id_fkey;
ALTER TABLE IF EXISTS ONLY public.sessions DROP CONSTRAINT IF EXISTS sessions_semester_id_fkey;
ALTER TABLE IF EXISTS ONLY public.sessions DROP CONSTRAINT IF EXISTS sessions_instructor_id_fkey;
ALTER TABLE IF EXISTS ONLY public.sessions DROP CONSTRAINT IF EXISTS sessions_group_id_fkey;
ALTER TABLE IF EXISTS ONLY public.session_quizzes DROP CONSTRAINT IF EXISTS session_quizzes_session_id_fkey;
ALTER TABLE IF EXISTS ONLY public.session_quizzes DROP CONSTRAINT IF EXISTS session_quizzes_quiz_id_fkey;
ALTER TABLE IF EXISTS ONLY public.session_group_students DROP CONSTRAINT IF EXISTS session_group_students_student_id_fkey;
ALTER TABLE IF EXISTS ONLY public.session_group_students DROP CONSTRAINT IF EXISTS session_group_students_session_group_id_fkey;
ALTER TABLE IF EXISTS ONLY public.session_group_assignments DROP CONSTRAINT IF EXISTS session_group_assignments_session_id_fkey;
ALTER TABLE IF EXISTS ONLY public.session_group_assignments DROP CONSTRAINT IF EXISTS session_group_assignments_instructor_id_fkey;
ALTER TABLE IF EXISTS ONLY public.session_group_assignments DROP CONSTRAINT IF EXISTS session_group_assignments_created_by_fkey;
ALTER TABLE IF EXISTS ONLY public.semesters DROP CONSTRAINT IF EXISTS semesters_tournament_type_id_fkey;
ALTER TABLE IF EXISTS ONLY public.semesters DROP CONSTRAINT IF EXISTS semesters_master_instructor_id_fkey;
ALTER TABLE IF EXISTS ONLY public.semesters DROP CONSTRAINT IF EXISTS semesters_location_id_fkey;
ALTER TABLE IF EXISTS ONLY public.semesters DROP CONSTRAINT IF EXISTS semesters_campus_id_fkey;
ALTER TABLE IF EXISTS ONLY public.semester_instructors DROP CONSTRAINT IF EXISTS semester_instructors_semester_id_fkey;
ALTER TABLE IF EXISTS ONLY public.semester_instructors DROP CONSTRAINT IF EXISTS semester_instructors_instructor_id_fkey;
ALTER TABLE IF EXISTS ONLY public.semester_enrollments DROP CONSTRAINT IF EXISTS semester_enrollments_user_license_id_fkey;
ALTER TABLE IF EXISTS ONLY public.semester_enrollments DROP CONSTRAINT IF EXISTS semester_enrollments_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.semester_enrollments DROP CONSTRAINT IF EXISTS semester_enrollments_semester_id_fkey;
ALTER TABLE IF EXISTS ONLY public.semester_enrollments DROP CONSTRAINT IF EXISTS semester_enrollments_payment_verified_by_fkey;
ALTER TABLE IF EXISTS ONLY public.semester_enrollments DROP CONSTRAINT IF EXISTS semester_enrollments_approved_by_fkey;
ALTER TABLE IF EXISTS ONLY public.semester_enrollments DROP CONSTRAINT IF EXISTS semester_enrollments_age_category_overridden_by_fkey;
ALTER TABLE IF EXISTS ONLY public.quiz_user_answers DROP CONSTRAINT IF EXISTS quiz_user_answers_selected_option_id_fkey;
ALTER TABLE IF EXISTS ONLY public.quiz_user_answers DROP CONSTRAINT IF EXISTS quiz_user_answers_question_id_fkey;
ALTER TABLE IF EXISTS ONLY public.quiz_user_answers DROP CONSTRAINT IF EXISTS quiz_user_answers_attempt_id_fkey;
...
ALTER TABLE IF EXISTS ONLY public.quiz_answer_options DROP CONSTRAINT IF EXISTS quiz_answer_options_question_id_fkey;
ALTER TABLE IF EXISTS ONLY public.question_metadata DROP CONSTRAINT IF EXISTS question_metadata_question_id_fkey;
ALTER TABLE IF EXISTS ONLY public.projects DROP CONSTRAINT IF EXISTS projects_semester_id_fkey;
ALTER TABLE IF EXISTS ONLY public.projects DROP CONSTRAINT IF EXISTS projects_instructor_id_fkey;
ALTER TABLE IF EXISTS ONLY public.project_sessions DROP CONSTRAINT IF EXISTS project_sessions_session_id_fkey;
ALTER TABLE IF EXISTS ONLY public.project_sessions DROP CONSTRAINT IF EXISTS project_sessions_project_id_fkey;
ALTER TABLE IF EXISTS ONLY public.project_sessions DROP CONSTRAINT IF EXISTS project_sessions_milestone_id_fkey;
ALTER TABLE IF EXISTS ONLY public.project_quizzes DROP CONSTRAINT IF EXISTS project_quizzes_quiz_id_fkey;
ALTER TABLE IF EXISTS ONLY public.project_quizzes DROP CONSTRAINT IF EXISTS project_quizzes_project_id_fkey;
ALTER TABLE IF EXISTS ONLY public.project_quizzes DROP CONSTRAINT IF EXISTS project_quizzes_milestone_id_fkey;
ALTER TABLE IF EXISTS ONLY public.project_milestones DROP CONSTRAINT IF EXISTS project_milestones_project_id_fkey;
ALTER TABLE IF EXISTS ONLY public.project_milestone_progress DROP CONSTRAINT IF EXISTS project_milestone_progress_milestone_id_fkey;
ALTER TABLE IF EXISTS ONLY public.project_milestone_progress DROP CONSTRAINT IF EXISTS project_milestone_progress_enrollment_id_fkey;
ALTER TABLE IF EXISTS ONLY public.project_enrollments DROP CONSTRAINT IF EXISTS project_enrollments_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.project_enrollments DROP CONSTRAINT IF EXISTS project_enrollments_project_id_fkey;
ALTER TABLE IF EXISTS ONLY public.project_enrollment_quizzes DROP CONSTRAINT IF EXISTS project_enrollment_quizzes_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.project_enrollment_quizzes DROP CONSTRAINT IF EXISTS project_enrollment_quizzes_quiz_attempt_id_fkey;
ALTER TABLE IF EXISTS ONLY public.project_enrollment_quizzes DROP CONSTRAINT IF EXISTS project_enrollment_quizzes_project_id_fkey;
ALTER TABLE IF EXISTS ONLY public.position_applications DROP CONSTRAINT IF EXISTS position_applications_position_id_fkey;
ALTER TABLE IF EXISTS ONLY public.position_applications DROP CONSTRAINT IF EXISTS position_applications_applicant_id_fkey;
ALTER TABLE IF EXISTS ONLY public.notifications DROP CONSTRAINT IF EXISTS notifications_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.notifications DROP CONSTRAINT IF EXISTS notifications_related_session_id_fkey;
ALTER TABLE IF EXISTS ONLY public.notifications DROP CONSTRAINT IF EXISTS notifications_related_semester_id_fkey;
ALTER TABLE IF EXISTS ONLY public.notifications DROP CONSTRAINT IF EXISTS notifications_related_request_id_fkey;
ALTER TABLE IF EXISTS ONLY public.notifications DROP CONSTRAINT IF EXISTS notifications_related_booking_id_fkey;
ALTER TABLE IF EXISTS ONLY public.modules DROP CONSTRAINT IF EXISTS modules_track_id_fkey;
ALTER TABLE IF EXISTS ONLY public.modules DROP CONSTRAINT IF EXISTS modules_semester_id_fkey;
ALTER TABLE IF EXISTS ONLY public.module_components DROP CONSTRAINT IF EXISTS module_components_module_id_fkey;
...
ALTER TABLE IF EXISTS ONLY public.location_master_instructors DROP CONSTRAINT IF EXISTS location_master_instructors_source_position_id_fkey;
ALTER TABLE IF EXISTS ONLY public.location_master_instructors DROP CONSTRAINT IF EXISTS location_master_instructors_location_id_fkey;
ALTER TABLE IF EXISTS ONLY public.location_master_instructors DROP CONSTRAINT IF EXISTS location_master_instructors_instructor_id_fkey;
ALTER TABLE IF EXISTS ONLY public.license_progressions DROP CONSTRAINT IF EXISTS license_progressions_user_license_id_fkey;
ALTER TABLE IF EXISTS ONLY public.license_progressions DROP CONSTRAINT IF EXISTS license_progressions_advanced_by_fkey;
ALTER TABLE IF EXISTS ONLY public.issued_certificates DROP CONSTRAINT IF EXISTS issued_certificates_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.issued_certificates DROP CONSTRAINT IF EXISTS issued_certificates_certificate_template_id_fkey;
ALTER TABLE IF EXISTS ONLY public.invoice_requests DROP CONSTRAINT IF EXISTS invoice_requests_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.invitation_codes DROP CONSTRAINT IF EXISTS invitation_codes_used_by_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.invitation_codes DROP CONSTRAINT IF EXISTS invitation_codes_created_by_admin_id_fkey;
ALTER TABLE IF EXISTS ONLY public.instructor_specializations DROP CONSTRAINT IF EXISTS instructor_specializations_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.instructor_specializations DROP CONSTRAINT IF EXISTS instructor_specializations_certified_by_fkey;
ALTER TABLE IF EXISTS ONLY public.instructor_specialization_availability DROP CONSTRAINT IF EXISTS instructor_specialization_availability_instructor_id_fkey;
ALTER TABLE IF EXISTS ONLY public.instructor_session_reviews DROP CONSTRAINT IF EXISTS instructor_session_reviews_student_id_fkey;
ALTER TABLE IF EXISTS ONLY public.instructor_session_reviews DROP CONSTRAINT IF EXISTS instructor_session_reviews_session_id_fkey;
ALTER TABLE IF EXISTS ONLY public.instructor_session_reviews DROP CONSTRAINT IF EXISTS instructor_session_reviews_instructor_id_fkey;
ALTER TABLE IF EXISTS ONLY public.instructor_positions DROP CONSTRAINT IF EXISTS instructor_positions_posted_by_fkey;
ALTER TABLE IF EXISTS ONLY public.instructor_positions DROP CONSTRAINT IF EXISTS instructor_positions_location_id_fkey;
ALTER TABLE IF EXISTS ONLY public.instructor_availability_windows DROP CONSTRAINT IF EXISTS instructor_availability_windows_instructor_id_fkey;
ALTER TABLE IF EXISTS ONLY public.instructor_assignments DROP CONSTRAINT IF EXISTS instructor_assignments_location_id_fkey;
ALTER TABLE IF EXISTS ONLY public.instructor_assignments DROP CONSTRAINT IF EXISTS instructor_assignments_instructor_id_fkey;
ALTER TABLE IF EXISTS ONLY public.instructor_assignments DROP CONSTRAINT IF EXISTS instructor_assignments_assigned_by_fkey;
ALTER TABLE IF EXISTS ONLY public.instructor_assignment_requests DROP CONSTRAINT IF EXISTS instructor_assignment_requests_semester_id_fkey;
ALTER TABLE IF EXISTS ONLY public.instructor_assignment_requests DROP CONSTRAINT IF EXISTS instructor_assignment_requests_requested_by_fkey;
ALTER TABLE IF EXISTS ONLY public.instructor_assignment_requests DROP CONSTRAINT IF EXISTS instructor_assignment_requests_location_id_fkey;
ALTER TABLE IF EXISTS ONLY public.instructor_assignment_requests DROP CONSTRAINT IF EXISTS instructor_assignment_requests_instructor_id_fkey;
ALTER TABLE IF EXISTS ONLY public.groups DROP CONSTRAINT IF EXISTS groups_semester_id_fkey;
ALTER TABLE IF EXISTS ONLY public.group_users DROP CONSTRAINT IF EXISTS group_users_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.group_users DROP CONSTRAINT IF EXISTS group_users_group_id_fkey;
ALTER TABLE IF EXISTS ONLY public.football_skill_assessments DROP CONSTRAINT IF EXISTS football_skill_assessments_user_license_id_fkey;
ALTER TABLE IF EXISTS ONLY public.football_skill_assessments DROP CONSTRAINT IF EXISTS football_skill_assessments_assessed_by_fkey;
ALTER TABLE IF EXISTS ONLY public.feedback DROP CONSTRAINT IF EXISTS feedback_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.feedback DROP CONSTRAINT IF EXISTS feedback_session_id_fkey;
ALTER TABLE IF EXISTS ONLY public.credit_transactions DROP CONSTRAINT IF EXISTS credit_transactions_user_license_id_fkey;
ALTER TABLE IF EXISTS ONLY public.credit_transactions DROP CONSTRAINT IF EXISTS credit_transactions_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.credit_transactions DROP CONSTRAINT IF EXISTS credit_transactions_semester_id_fkey;
ALTER TABLE IF EXISTS ONLY public.credit_transactions DROP CONSTRAINT IF EXISTS credit_transactions_enrollment_id_fkey;
ALTER TABLE IF EXISTS ONLY public.coupon_usages DROP CONSTRAINT IF EXISTS coupon_usages_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.coupon_usages DROP CONSTRAINT IF EXISTS coupon_usages_coupon_id_fkey;
ALTER TABLE IF EXISTS ONLY public.certificate_templates DROP CONSTRAINT IF EXISTS certificate_templates_track_id_fkey;
ALTER TABLE IF EXISTS ONLY public.campuses DROP CONSTRAINT IF EXISTS campuses_location_id_fkey;
ALTER TABLE IF EXISTS ONLY public.bookings DROP CONSTRAINT IF EXISTS bookings_user_id_fkey;
ALTER TABLE IF EXISTS ONLY public.bookings DROP CONSTRAINT IF EXISTS bookings_session_id_fkey;
ALTER TABLE IF EXISTS ONLY public.bookings DROP CONSTRAINT IF EXISTS bookings_enrollment_id_fkey;
ALTER TABLE IF EXISTS ONLY public.belt_promotions DROP CONSTRAINT IF EXISTS belt_promotions_user_license_id_fkey;
ALTER TABLE IF EXISTS ONLY public.belt_promotions DROP CONSTRAINT IF EXISTS belt_promotions_promoted_by_fkey;
...
ALTER TABLE IF EXISTS ONLY public.attendance DROP CONSTRAINT IF EXISTS attendance_marked_by_fkey;
ALTER TABLE IF EXISTS ONLY public.attendance_history DROP CONSTRAINT IF EXISTS attendance_history_changed_by_fkey;
ALTER TABLE IF EXISTS ONLY public.attendance_history DROP CONSTRAINT IF EXISTS attendance_history_attendance_id_fkey;
ALTER TABLE IF EXISTS ONLY public.attendance DROP CONSTRAINT IF EXISTS attendance_change_requested_by_fkey;
ALTER TABLE IF EXISTS ONLY public.attendance DROP CONSTRAINT IF EXISTS attendance_booking_id_fkey;
ALTER TABLE IF EXISTS ONLY public.adaptive_learning_sessions DROP CONSTRAINT IF EXISTS adaptive_learning_sessions_user_id_fkey;
DROP INDEX IF EXISTS public.ix_users_id;
DROP INDEX IF EXISTS public.ix_users_email;
DROP INDEX IF EXISTS public.ix_user_stats_id;
DROP INDEX IF EXISTS public.ix_user_question_performance_id;
DROP INDEX IF EXISTS public.ix_user_licenses_payment_reference_code;
DROP INDEX IF EXISTS public.ix_user_licenses_id;
DROP INDEX IF EXISTS public.ix_user_achievements_id;
DROP INDEX IF EXISTS public.ix_tournament_types_id;
DROP INDEX IF EXISTS public.ix_tournament_types_code;
DROP INDEX IF EXISTS public.ix_tournament_team_enrollments_team_id;
DROP INDEX IF EXISTS public.ix_tournament_team_enrollments_semester_id;
DROP INDEX IF EXISTS public.ix_tournament_team_enrollments_id;
DROP INDEX IF EXISTS public.ix_tournament_status_history_tournament_id;
DROP INDEX IF EXISTS public.ix_tournament_status_history_id;
DROP INDEX IF EXISTS public.ix_tournament_stats_tournament_id;
DROP INDEX IF EXISTS public.ix_tournament_stats_id;
DROP INDEX IF EXISTS public.ix_tournament_rewards_tournament_id;
DROP INDEX IF EXISTS public.ix_tournament_rewards_id;
DROP INDEX IF EXISTS public.ix_tournament_rankings_tournament_id;
DROP INDEX IF EXISTS public.ix_tournament_rankings_id;
DROP INDEX IF EXISTS public.ix_teams_id;
DROP INDEX IF EXISTS public.ix_teams_code;
...
DROP INDEX IF EXISTS public.ix_student_performance_reviews_id;
DROP INDEX IF EXISTS public.ix_sessions_is_tournament_game;
DROP INDEX IF EXISTS public.ix_sessions_id;
DROP INDEX IF EXISTS public.ix_session_quizzes_id;
DROP INDEX IF EXISTS public.ix_session_group_students_session_group_id;
DROP INDEX IF EXISTS public.ix_session_group_students_id;
DROP INDEX IF EXISTS public.ix_session_group_assignments_session_id;
DROP INDEX IF EXISTS public.ix_session_group_assignments_id;
DROP INDEX IF EXISTS public.ix_semesters_tournament_status;
DROP INDEX IF EXISTS public.ix_semesters_status;
DROP INDEX IF EXISTS public.ix_semesters_specialization_type;
DROP INDEX IF EXISTS public.ix_semesters_location_id;
DROP INDEX IF EXISTS public.ix_semesters_id;
DROP INDEX IF EXISTS public.ix_semesters_code;
DROP INDEX IF EXISTS public.ix_semesters_campus_id;
DROP INDEX IF EXISTS public.ix_semesters_age_group;
DROP INDEX IF EXISTS public.ix_semester_enrollments_user_license_id;
DROP INDEX IF EXISTS public.ix_semester_enrollments_user_id;
DROP INDEX IF EXISTS public.ix_semester_enrollments_semester_id;
DROP INDEX IF EXISTS public.ix_semester_enrollments_payment_verified;
DROP INDEX IF EXISTS public.ix_semester_enrollments_is_active;
DROP INDEX IF EXISTS public.ix_semester_enrollments_id;
DROP INDEX IF EXISTS public.ix_quizzes_id;
DROP INDEX IF EXISTS public.ix_quiz_user_answers_id;
DROP INDEX IF EXISTS public.ix_quiz_questions_id;
DROP INDEX IF EXISTS public.ix_quiz_attempts_id;
DROP INDEX IF EXISTS public.ix_quiz_answer_options_id;
DROP INDEX IF EXISTS public.ix_question_metadata_id;
DROP INDEX IF EXISTS public.ix_projects_id;
DROP INDEX IF EXISTS public.ix_project_sessions_id;
DROP INDEX IF EXISTS public.ix_project_quizzes_id;
DROP INDEX IF EXISTS public.ix_project_milestones_id;
DROP INDEX IF EXISTS public.ix_project_milestone_progress_id;
DROP INDEX IF EXISTS public.ix_project_enrollments_id;
DROP INDEX IF EXISTS public.ix_project_enrollment_quizzes_id;
DROP INDEX IF EXISTS public.ix_position_applications_id;
...
DROP INDEX IF EXISTS public.ix_location_master_instructors_id;
DROP INDEX IF EXISTS public.ix_license_progressions_id;
DROP INDEX IF EXISTS public.ix_license_metadata_id;
DROP INDEX IF EXISTS public.ix_invoice_requests_payment_reference;
DROP INDEX IF EXISTS public.ix_invoice_requests_id;
DROP INDEX IF EXISTS public.ix_invitation_codes_id;
DROP INDEX IF EXISTS public.ix_invitation_codes_code;
DROP INDEX IF EXISTS public.ix_instructor_specializations_id;
DROP INDEX IF EXISTS public.ix_instructor_specialization_availability_id;
DROP INDEX IF EXISTS public.ix_instructor_session_reviews_id;
DROP INDEX IF EXISTS public.ix_instructor_positions_id;
DROP INDEX IF EXISTS public.ix_instructor_availability_windows_id;
DROP INDEX IF EXISTS public.ix_instructor_assignments_id;
DROP INDEX IF EXISTS public.ix_instructor_assignment_requests_id;
DROP INDEX IF EXISTS public.ix_groups_id;
DROP INDEX IF EXISTS public.ix_football_skill_assessments_id;
DROP INDEX IF EXISTS public.ix_feedback_id;
DROP INDEX IF EXISTS public.ix_credit_transactions_user_license_id;
DROP INDEX IF EXISTS public.ix_credit_transactions_user_id;
DROP INDEX IF EXISTS public.ix_credit_transactions_id;
DROP INDEX IF EXISTS public.ix_credit_transactions_created_at;
DROP INDEX IF EXISTS public.ix_coupons_id;
DROP INDEX IF EXISTS public.ix_coupons_code;
DROP INDEX IF EXISTS public.ix_coupon_usages_id;
DROP INDEX IF EXISTS public.ix_campuses_id;
DROP INDEX IF EXISTS public.ix_bookings_id;
DROP INDEX IF EXISTS public.ix_bookings_enrollment_id;
DROP INDEX IF EXISTS public.ix_belt_promotions_user_license_id;
DROP INDEX IF EXISTS public.ix_belt_promotions_to_belt;
DROP INDEX IF EXISTS public.ix_belt_promotions_promoted_at;
DROP INDEX IF EXISTS public.ix_belt_promotions_id;
...
DROP INDEX IF EXISTS public.ix_attendance_id;
DROP INDEX IF EXISTS public.ix_attendance_history_id;
DROP INDEX IF EXISTS public.ix_adaptive_learning_sessions_id;
DROP INDEX IF EXISTS public.ix_achievements_is_active;
DROP INDEX IF EXISTS public.ix_achievements_id;
DROP INDEX IF EXISTS public.ix_achievements_code;
DROP INDEX IF EXISTS public.ix_achievements_category;
ALTER TABLE IF EXISTS ONLY public.users DROP CONSTRAINT IF EXISTS users_pkey;
ALTER TABLE IF EXISTS ONLY public.users DROP CONSTRAINT IF EXISTS users_credit_payment_reference_key;
ALTER TABLE IF EXISTS ONLY public.user_track_progresses DROP CONSTRAINT IF EXISTS user_track_progresses_pkey;
ALTER TABLE IF EXISTS ONLY public.user_stats DROP CONSTRAINT IF EXISTS user_stats_user_id_key;
ALTER TABLE IF EXISTS ONLY public.user_stats DROP CONSTRAINT IF EXISTS user_stats_pkey;
ALTER TABLE IF EXISTS ONLY public.user_question_performance DROP CONSTRAINT IF EXISTS user_question_performance_pkey;
ALTER TABLE IF EXISTS ONLY public.user_module_progresses DROP CONSTRAINT IF EXISTS user_module_progresses_pkey;
ALTER TABLE IF EXISTS ONLY public.user_licenses DROP CONSTRAINT IF EXISTS user_licenses_pkey;
ALTER TABLE IF EXISTS ONLY public.user_achievements DROP CONSTRAINT IF EXISTS user_achievements_pkey;
ALTER TABLE IF EXISTS ONLY public.session_quizzes DROP CONSTRAINT IF EXISTS uq_session_quiz;
ALTER TABLE IF EXISTS ONLY public.session_group_students DROP CONSTRAINT IF EXISTS uq_session_group_student;
ALTER TABLE IF EXISTS ONLY public.session_group_assignments DROP CONSTRAINT IF EXISTS uq_session_group_number;
ALTER TABLE IF EXISTS ONLY public.semester_enrollments DROP CONSTRAINT IF EXISTS uq_semester_enrollments_user_semester_license;
ALTER TABLE IF EXISTS ONLY public.user_question_performance DROP CONSTRAINT IF EXISTS unique_user_question;
ALTER TABLE IF EXISTS ONLY public.question_metadata DROP CONSTRAINT IF EXISTS unique_question_metadata;
ALTER TABLE IF EXISTS ONLY public.project_enrollment_quizzes DROP CONSTRAINT IF EXISTS unique_project_user_enrollment_quiz;
ALTER TABLE IF EXISTS ONLY public.project_enrollments DROP CONSTRAINT IF EXISTS unique_project_user;
ALTER TABLE IF EXISTS ONLY public.project_sessions DROP CONSTRAINT IF EXISTS unique_project_session;
ALTER TABLE IF EXISTS ONLY public.project_quizzes DROP CONSTRAINT IF EXISTS unique_project_quiz_type;
ALTER TABLE IF EXISTS ONLY public.project_milestone_progress DROP CONSTRAINT IF EXISTS unique_enrollment_milestone;
ALTER TABLE IF EXISTS ONLY public.instructor_specialization_availability DROP CONSTRAINT IF EXISTS uix_instructor_spec_period_year_location;
ALTER TABLE IF EXISTS ONLY public.tracks DROP CONSTRAINT IF EXISTS tracks_pkey;
ALTER TABLE IF EXISTS ONLY public.tracks DROP CONSTRAINT IF EXISTS tracks_code_key;
ALTER TABLE IF EXISTS ONLY public.tournament_types DROP CONSTRAINT IF EXISTS tournament_types_pkey;
ALTER TABLE IF EXISTS ONLY public.tournament_team_enrollments DROP CONSTRAINT IF EXISTS tournament_team_enrollments_pkey;
ALTER TABLE IF EXISTS ONLY public.tournament_status_history DROP CONSTRAINT IF EXISTS tournament_status_history_pkey;
ALTER TABLE IF EXISTS ONLY public.tournament_stats DROP CONSTRAINT IF EXISTS tournament_stats_pkey;
ALTER TABLE IF EXISTS ONLY public.tournament_rewards DROP CONSTRAINT IF EXISTS tournament_rewards_pkey;
ALTER TABLE IF EXISTS ONLY public.tournament_rankings DROP CONSTRAINT IF EXISTS tournament_rankings_pkey;
...
ALTER TABLE IF EXISTS ONLY public.student_performance_reviews DROP CONSTRAINT IF EXISTS student_performance_reviews_pkey;
ALTER TABLE IF EXISTS ONLY public.specializations DROP CONSTRAINT IF EXISTS specializations_pkey;
ALTER TABLE IF EXISTS ONLY public.specialization_progress DROP CONSTRAINT IF EXISTS specialization_progress_pkey;
ALTER TABLE IF EXISTS ONLY public.sessions DROP CONSTRAINT IF EXISTS sessions_pkey;
ALTER TABLE IF EXISTS ONLY public.session_quizzes DROP CONSTRAINT IF EXISTS session_quizzes_pkey;
ALTER TABLE IF EXISTS ONLY public.session_group_students DROP CONSTRAINT IF EXISTS session_group_students_pkey;
ALTER TABLE IF EXISTS ONLY public.session_group_assignments DROP CONSTRAINT IF EXISTS session_group_assignments_pkey;
ALTER TABLE IF EXISTS ONLY public.semesters DROP CONSTRAINT IF EXISTS semesters_pkey;
ALTER TABLE IF EXISTS ONLY public.semester_instructors DROP CONSTRAINT IF EXISTS semester_instructors_pkey;
ALTER TABLE IF EXISTS ONLY public.semester_enrollments DROP CONSTRAINT IF EXISTS semester_enrollments_pkey;
ALTER TABLE IF EXISTS ONLY public.semester_enrollments DROP CONSTRAINT IF EXISTS semester_enrollments_payment_reference_code_key;
ALTER TABLE IF EXISTS ONLY public.quizzes DROP CONSTRAINT IF EXISTS quizzes_pkey;
ALTER TABLE IF EXISTS ONLY public.quiz_user_answers DROP CONSTRAINT IF EXISTS quiz_user_answers_pkey;
...
ALTER TABLE IF EXISTS ONLY public.quiz_answer_options DROP CONSTRAINT IF EXISTS quiz_answer_options_pkey;
ALTER TABLE IF EXISTS ONLY public.question_metadata DROP CONSTRAINT IF EXISTS question_metadata_pkey;
ALTER TABLE IF EXISTS ONLY public.projects DROP CONSTRAINT IF EXISTS projects_pkey;
ALTER TABLE IF EXISTS ONLY public.project_sessions DROP CONSTRAINT IF EXISTS project_sessions_pkey;
ALTER TABLE IF EXISTS ONLY public.project_quizzes DROP CONSTRAINT IF EXISTS project_quizzes_pkey;
ALTER TABLE IF EXISTS ONLY public.project_milestones DROP CONSTRAINT IF EXISTS project_milestones_pkey;
ALTER TABLE IF EXISTS ONLY public.project_milestone_progress DROP CONSTRAINT IF EXISTS project_milestone_progress_pkey;
ALTER TABLE IF EXISTS ONLY public.project_enrollments DROP CONSTRAINT IF EXISTS project_enrollments_pkey;
ALTER TABLE IF EXISTS ONLY public.project_enrollment_quizzes DROP CONSTRAINT IF EXISTS project_enrollment_quizzes_pkey;
ALTER TABLE IF EXISTS ONLY public.position_applications DROP CONSTRAINT IF EXISTS position_applications_pkey;
ALTER TABLE IF EXISTS ONLY public.player_levels DROP CONSTRAINT IF EXISTS player_levels_pkey;
ALTER TABLE IF EXISTS ONLY public.notifications DROP CONSTRAINT IF EXISTS notifications_pkey;
ALTER TABLE IF EXISTS ONLY public.modules DROP CONSTRAINT IF EXISTS modules_pkey;
ALTER TABLE IF EXISTS ONLY public.module_components DROP CONSTRAINT IF EXISTS module_components_pkey;
...
ALTER TABLE IF EXISTS ONLY public.locations DROP CONSTRAINT IF EXISTS locations_city_key;
ALTER TABLE IF EXISTS ONLY public.location_master_instructors DROP CONSTRAINT IF EXISTS location_master_instructors_pkey;
ALTER TABLE IF EXISTS ONLY public.license_progressions DROP CONSTRAINT IF EXISTS license_progressions_pkey;
ALTER TABLE IF EXISTS ONLY public.license_metadata DROP CONSTRAINT IF EXISTS license_metadata_pkey;
ALTER TABLE IF EXISTS ONLY public.issued_certificates DROP CONSTRAINT IF EXISTS issued_certificates_unique_identifier_key;
ALTER TABLE IF EXISTS ONLY public.issued_certificates DROP CONSTRAINT IF EXISTS issued_certificates_pkey;
ALTER TABLE IF EXISTS ONLY public.invoice_requests DROP CONSTRAINT IF EXISTS invoice_requests_pkey;
ALTER TABLE IF EXISTS ONLY public.invitation_codes DROP CONSTRAINT IF EXISTS invitation_codes_pkey;
ALTER TABLE IF EXISTS ONLY public.internship_levels DROP CONSTRAINT IF EXISTS internship_levels_pkey;
ALTER TABLE IF EXISTS ONLY public.instructor_specializations DROP CONSTRAINT IF EXISTS instructor_specializations_pkey;
ALTER TABLE IF EXISTS ONLY public.instructor_specialization_availability DROP CONSTRAINT IF EXISTS instructor_specialization_availability_pkey;
ALTER TABLE IF EXISTS ONLY public.instructor_session_reviews DROP CONSTRAINT IF EXISTS instructor_session_reviews_pkey;
ALTER TABLE IF EXISTS ONLY public.instructor_positions DROP CONSTRAINT IF EXISTS instructor_positions_pkey;
ALTER TABLE IF EXISTS ONLY public.instructor_availability_windows DROP CONSTRAINT IF EXISTS instructor_availability_windows_pkey;
ALTER TABLE IF EXISTS ONLY public.instructor_assignments DROP CONSTRAINT IF EXISTS instructor_assignments_pkey;
ALTER TABLE IF EXISTS ONLY public.instructor_assignment_requests DROP CONSTRAINT IF EXISTS instructor_assignment_requests_pkey;
ALTER TABLE IF EXISTS ONLY public.groups DROP CONSTRAINT IF EXISTS groups_pkey;
ALTER TABLE IF EXISTS ONLY public.group_users DROP CONSTRAINT IF EXISTS group_users_pkey;
ALTER TABLE IF EXISTS ONLY public.football_skill_assessments DROP CONSTRAINT IF EXISTS football_skill_assessments_pkey;
...
ALTER TABLE IF EXISTS ONLY public.coach_levels DROP CONSTRAINT IF EXISTS coach_levels_pkey;
...
ALTER TABLE IF EXISTS ONLY public.belt_promotions DROP CONSTRAINT IF EXISTS belt_promotions_pkey;
ALTER TABLE IF EXISTS ONLY public.audit_logs DROP CONSTRAINT IF EXISTS audit_logs_pkey;
ALTER TABLE IF EXISTS ONLY public.attendance DROP CONSTRAINT IF EXISTS attendance_pkey;
ALTER TABLE IF EXISTS ONLY public.attendance_history DROP CONSTRAINT IF EXISTS attendance_history_pkey;
ALTER TABLE IF EXISTS ONLY public.alembic_version DROP CONSTRAINT IF EXISTS alembic_version_pkc;
ALTER TABLE IF EXISTS ONLY public.adaptive_learning_sessions DROP CONSTRAINT IF EXISTS adaptive_learning_sessions_pkey;
ALTER TABLE IF EXISTS ONLY public.achievements DROP CONSTRAINT IF EXISTS achievements_pkey;
ALTER TABLE IF EXISTS public.users ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.user_stats ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.user_question_performance ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.user_licenses ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.user_achievements ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.tournament_types ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.tournament_team_enrollments ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.tournament_status_history ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.tournament_stats ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.tournament_rewards ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.tournament_rankings ALTER COLUMN id DROP DEFAULT;
...
ALTER TABLE IF EXISTS public.student_performance_reviews ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.specialization_progress ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.sessions ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.session_quizzes ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.session_group_students ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.session_group_assignments ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.semesters ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.semester_enrollments ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.quizzes ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.quiz_user_answers ALTER COLUMN id DROP DEFAULT;
...
ALTER TABLE IF EXISTS public.quiz_answer_options ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.question_metadata ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.projects ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.project_sessions ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.project_quizzes ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.project_milestones ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.project_milestone_progress ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.project_enrollments ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.project_enrollment_quizzes ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.position_applications ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.player_levels ALTER COLUMN id DROP DEFAULT;
...
ALTER TABLE IF EXISTS public.location_master_instructors ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.license_progressions ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.license_metadata ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.invoice_requests ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.invitation_codes ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.internship_levels ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.instructor_specializations ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.instructor_specialization_availability ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.instructor_session_reviews ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.instructor_positions ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.instructor_availability_windows ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.instructor_assignments ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.instructor_assignment_requests ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.groups ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.football_skill_assessments ALTER COLUMN id DROP DEFAULT;
...
ALTER TABLE IF EXISTS public.coupon_usages ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.coach_levels ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.campuses ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.bookings ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.belt_promotions ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.audit_logs ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.attendance_history ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.attendance ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.adaptive_learning_sessions ALTER COLUMN id DROP DEFAULT;
ALTER TABLE IF EXISTS public.achievements ALTER COLUMN id DROP DEFAULT;
DROP SEQUENCE IF EXISTS public.users_id_seq;
DROP TABLE IF EXISTS public.users;
DROP TABLE IF EXISTS public.user_track_progresses;
DROP SEQUENCE IF EXISTS public.user_stats_id_seq;
DROP TABLE IF EXISTS public.user_stats;
DROP SEQUENCE IF EXISTS public.user_question_performance_id_seq;
DROP TABLE IF EXISTS public.user_question_performance;
DROP TABLE IF EXISTS public.user_module_progresses;
DROP SEQUENCE IF EXISTS public.user_licenses_id_seq;
...
DROP SEQUENCE IF EXISTS public.tournament_types_id_seq;
DROP TABLE IF EXISTS public.tournament_types;
DROP SEQUENCE IF EXISTS public.tournament_team_enrollments_id_seq;
DROP TABLE IF EXISTS public.tournament_team_enrollments;
DROP SEQUENCE IF EXISTS public.tournament_status_history_id_seq;
DROP TABLE IF EXISTS public.tournament_status_history;
DROP SEQUENCE IF EXISTS public.tournament_stats_id_seq;
DROP TABLE IF EXISTS public.tournament_stats;
DROP SEQUENCE IF EXISTS public.tournament_rewards_id_seq;
DROP TABLE IF EXISTS public.tournament_rewards;
DROP SEQUENCE IF EXISTS public.tournament_rankings_id_seq;
DROP TABLE IF EXISTS public.tournament_rankings;
DROP SEQUENCE IF EXISTS public.teams_id_seq;
DROP TABLE IF EXISTS public.teams;
DROP SEQUENCE IF EXISTS public.team_members_id_seq;
DROP TABLE IF EXISTS public.team_members;
DROP SEQUENCE IF EXISTS public.student_performance_reviews_id_seq;
DROP TABLE IF EXISTS public.student_performance_reviews;
DROP TABLE IF EXISTS public.specializations;
DROP SEQUENCE IF EXISTS public.specialization_progress_id_seq;
DROP TABLE IF EXISTS public.specialization_progress;
DROP SEQUENCE IF EXISTS public.sessions_id_seq;
DROP TABLE IF EXISTS public.sessions;
DROP SEQUENCE IF EXISTS public.session_quizzes_id_seq;
DROP TABLE IF EXISTS public.session_quizzes;
DROP SEQUENCE IF EXISTS public.session_group_students_id_seq;
DROP TABLE IF EXISTS public.session_group_students;
DROP SEQUENCE IF EXISTS public.session_group_assignments_id_seq;
DROP TABLE IF EXISTS public.session_group_assignments;
DROP SEQUENCE IF EXISTS public.semesters_id_seq;
DROP TABLE IF EXISTS public.semesters;
DROP TABLE IF EXISTS public.semester_instructors;
DROP SEQUENCE IF EXISTS public.semester_enrollments_id_seq;
DROP TABLE IF EXISTS public.semester_enrollments;
DROP SEQUENCE IF EXISTS public.quizzes_id_seq;
DROP TABLE IF EXISTS public.quizzes;
DROP SEQUENCE IF EXISTS public.quiz_user_answers_id_seq;
DROP TABLE IF EXISTS public.quiz_user_answers;
...
DROP SEQUENCE IF EXISTS public.quiz_answer_options_id_seq;
DROP TABLE IF EXISTS public.quiz_answer_options;
DROP SEQUENCE IF EXISTS public.question_metadata_id_seq;
DROP TABLE IF EXISTS public.question_metadata;
DROP SEQUENCE IF EXISTS public.projects_id_seq;
DROP TABLE IF EXISTS public.projects;
DROP SEQUENCE IF EXISTS public.project_sessions_id_seq;
DROP TABLE IF EXISTS public.project_sessions;
DROP SEQUENCE IF EXISTS public.project_quizzes_id_seq;
DROP TABLE IF EXISTS public.project_quizzes;
DROP SEQUENCE IF EXISTS public.project_milestones_id_seq;
DROP TABLE IF EXISTS public.project_milestones;
DROP SEQUENCE IF EXISTS public.project_milestone_progress_id_seq;
DROP TABLE IF EXISTS public.project_milestone_progress;
DROP SEQUENCE IF EXISTS public.project_enrollments_id_seq;
DROP TABLE IF EXISTS public.project_enrollments;
DROP SEQUENCE IF EXISTS public.project_enrollment_quizzes_id_seq;
DROP TABLE IF EXISTS public.project_enrollment_quizzes;
DROP SEQUENCE IF EXISTS public.position_applications_id_seq;
DROP TABLE IF EXISTS public.position_applications;
DROP SEQUENCE IF EXISTS public.player_levels_id_seq;
DROP TABLE IF EXISTS public.player_levels;
DROP SEQUENCE IF EXISTS public.notifications_id_seq;
DROP TABLE IF EXISTS public.notifications;
DROP TABLE IF EXISTS public.modules;
DROP TABLE IF EXISTS public.module_components;
DROP SEQUENCE IF EXISTS public.messages_id_seq;
DROP TABLE IF EXISTS public.messages;
DROP SEQUENCE IF EXISTS public.locations_id_seq;
DROP TABLE IF EXISTS public.locations;
DROP SEQUENCE IF EXISTS public.location_master_instructors_id_seq;
DROP TABLE IF EXISTS public.location_master_instructors;
DROP SEQUENCE IF EXISTS public.license_progressions_id_seq;
DROP TABLE IF EXISTS public.license_progressions;
DROP SEQUENCE IF EXISTS public.license_metadata_id_seq;
DROP TABLE IF EXISTS public.license_metadata;
DROP TABLE IF EXISTS public.issued_certificates;
DROP SEQUENCE IF EXISTS public.invoice_requests_id_seq;
...
DROP SEQUENCE IF EXISTS public.internship_levels_id_seq;
DROP TABLE IF EXISTS public.internship_levels;
DROP SEQUENCE IF EXISTS public.instructor_specializations_id_seq;
DROP TABLE IF EXISTS public.instructor_specializations;
DROP SEQUENCE IF EXISTS public.instructor_specialization_availability_id_seq;
DROP TABLE IF EXISTS public.instructor_specialization_availability;
DROP SEQUENCE IF EXISTS public.instructor_session_reviews_id_seq;
DROP TABLE IF EXISTS public.instructor_session_reviews;
DROP SEQUENCE IF EXISTS public.instructor_positions_id_seq;
DROP TABLE IF EXISTS public.instructor_positions;
DROP SEQUENCE IF EXISTS public.instructor_availability_windows_id_seq;
DROP TABLE IF EXISTS public.instructor_availability_windows;
DROP SEQUENCE IF EXISTS public.instructor_assignments_id_seq;
DROP TABLE IF EXISTS public.instructor_assignments;
DROP SEQUENCE IF EXISTS public.instructor_assignment_requests_id_seq;
DROP TABLE IF EXISTS public.instructor_assignment_requests;
DROP SEQUENCE IF EXISTS public.groups_id_seq;
DROP TABLE IF EXISTS public.groups;
DROP TABLE IF EXISTS public.group_users;
DROP SEQUENCE IF EXISTS public.football_skill_assessments_id_seq;
DROP TABLE IF EXISTS public.football_skill_assessments;
...
DROP SEQUENCE IF EXISTS public.coupon_usages_id_seq;
DROP TABLE IF EXISTS public.coupon_usages;
DROP SEQUENCE IF EXISTS public.coach_levels_id_seq;
DROP TABLE IF EXISTS public.coach_levels;
DROP TABLE IF EXISTS public.certificate_templates;
DROP SEQUENCE IF EXISTS public.campuses_id_seq;
DROP TABLE IF EXISTS public.campuses;
DROP SEQUENCE IF EXISTS public.bookings_id_seq;
DROP TABLE IF EXISTS public.bookings;
DROP SEQUENCE IF EXISTS public.belt_promotions_id_seq;
DROP TABLE IF EXISTS public.belt_promotions;
DROP SEQUENCE IF EXISTS public.audit_logs_id_seq;
DROP TABLE IF EXISTS public.audit_logs;
DROP SEQUENCE IF EXISTS public.attendance_id_seq;
DROP SEQUENCE IF EXISTS public.attendance_history_id_seq;
DROP TABLE IF EXISTS public.attendance_history;
DROP TABLE IF EXISTS public.attendance;
DROP TABLE IF EXISTS public.alembic_version;
DROP SEQUENCE IF EXISTS public.adaptive_learning_sessions_id_seq;
DROP TABLE IF EXISTS public.adaptive_learning_sessions;
DROP SEQUENCE IF EXISTS public.achievements_id_seq;
DROP TABLE IF EXISTS public.achievements;
DROP TYPE IF EXISTS public.userrole;
DROP TYPE IF EXISTS public.trackprogressstatus;
DROP TYPE IF EXISTS public.specializationtype;
DROP TYPE IF EXISTS public.sessiontype;
DROP TYPE IF EXISTS public.semester_status;
DROP TYPE IF EXISTS public.quizdifficulty;
DROP TYPE IF EXISTS public.quizcategory;
DROP TYPE IF EXISTS public.questiontype;
DROP TYPE IF EXISTS public.positionstatus;
DROP TYPE IF EXISTS public.notificationtype;
DROP TYPE IF EXISTS public.moduleprogressstatus;
DROP TYPE IF EXISTS public.messagepriority;
DROP TYPE IF EXISTS public.masterofferstatus;
DROP TYPE IF EXISTS public.locationtype;
DROP TYPE IF EXISTS public.enrollmentstatus;
DROP TYPE IF EXISTS public.coupontype;
DROP TYPE IF EXISTS public.confirmationstatus;
DROP TYPE IF EXISTS public.bookingstatus;
DROP TYPE IF EXISTS public.attendancestatus;
DROP TYPE IF EXISTS public.assignmentrequeststatus;
...
1	1	LOGIN	\N	\N	{"email": "admin@lfa.com", "role": "admin", "success": true}	\N	\N	\N	\N	\N	2026-01-16 13:39:12.572919+01
2	1	POST_/api/v1/admin/coupons	\N	\N	null	127.0.0.1	python-requests/2.32.5	POST	/api/v1/admin/coupons	201	2026-01-16 13:39:12.810196+01
3	1	POST_/api/v1/admin/coupons	\N	\N	null	127.0.0.1	python-requests/2.32.5	POST	/api/v1/admin/coupons	201	2026-01-16 13:39:12.822467+01
4	1	POST_/api/v1/admin/coupons	\N	\N	null	127.0.0.1	python-requests/2.32.5	POST	/api/v1/admin/coupons	201	2026-01-16 13:39:12.833781+01
5	1	LOGIN	\N	\N	{"email": "admin@lfa.com", "role": "admin", "success": true}	\N	\N	\N	\N	\N	2026-01-16 13:39:20.424402+01
6	1	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:39:20.696256+01
7	1	GET_/api/v1/admin/locations/	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/admin/locations/	200	2026-01-16 13:39:20.821506+01
8	1	GET_/api/v1/admin/locations/2/campuses	location	2	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/admin/locations/2/campuses	200	2026-01-16 13:39:20.947205+01
9	1	GET_/api/v1/admin/coupons	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/admin/coupons	200	2026-01-16 13:39:22.987717+01
10	1	GET_/api/v1/admin/invitation-codes	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/admin/invitation-codes	200	2026-01-16 13:39:23.020158+01
11	1	GET_/api/v1/admin/coupons	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/admin/coupons	200	2026-01-16 13:39:27.071968+01
12	1	GET_/api/v1/admin/coupons	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/admin/coupons	200	2026-01-16 13:39:27.134501+01
13	1	GET_/api/v1/admin/invitation-codes	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/admin/invitation-codes	200	2026-01-16 13:39:27.1566+01
14	1	POST_/api/v1/admin/invitation-codes	\N	\N	null	127.0.0.1	python-requests/2.32.5	POST	/api/v1/admin/invitation-codes	200	2026-01-16 13:39:31.453216+01
15	1	GET_/api/v1/admin/coupons	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/admin/coupons	200	2026-01-16 13:39:40.524986+01
16	1	GET_/api/v1/admin/coupons	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/admin/coupons	200	2026-01-16 13:39:40.592979+01
17	1	GET_/api/v1/admin/invitation-codes	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/admin/invitation-codes	200	2026-01-16 13:39:40.617884+01
18	1	POST_/api/v1/admin/invitation-codes	\N	\N	null	127.0.0.1	python-requests/2.32.5	POST	/api/v1/admin/invitation-codes	200	2026-01-16 13:39:44.760507+01
19	1	GET_/api/v1/admin/coupons	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/admin/coupons	200	2026-01-16 13:39:53.90267+01
20	1	GET_/api/v1/admin/coupons	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/admin/coupons	200	2026-01-16 13:39:53.974874+01
21	1	GET_/api/v1/admin/invitation-codes	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/admin/invitation-codes	200	2026-01-16 13:39:53.998472+01
22	1	POST_/api/v1/admin/invitation-codes	\N	\N	null	127.0.0.1	python-requests/2.32.5	POST	/api/v1/admin/invitation-codes	200	2026-01-16 13:39:58.151089+01
23	4	USER_CREATED	\N	\N	{"email": "pwt.k1sqx1@f1stteam.hu", "name": "Krist\\u00f3f Kis", "invitation_code": "INV-20260116-7GZS5W", "bonus_credits": 50, "registration_type": "invitation_code"}	\N	\N	\N	\N	\N	2026-01-16 13:40:35.650443+01
24	\N	POST_/api/v1/auth/register-with-invitation	\N	\N	null	127.0.0.1	python-requests/2.32.5	POST	/api/v1/auth/register-with-invitation	200	2026-01-16 13:40:35.665215+01
25	5	USER_CREATED	\N	\N	{"email": "pwt.p3t1k3@f1stteam.hu", "name": "P\\u00e9ter Pataki", "invitation_code": "INV-20260116-GL1D2N", "bonus_credits": 50, "registration_type": "invitation_code"}	\N	\N	\N	\N	\N	2026-01-16 13:41:08.469866+01
26	\N	POST_/api/v1/auth/register-with-invitation	\N	\N	null	127.0.0.1	python-requests/2.32.5	POST	/api/v1/auth/register-with-invitation	200	2026-01-16 13:41:08.483877+01
27	6	USER_CREATED	\N	\N	{"email": "pwt.V4lv3rd3jr@f1stteam.hu", "name": "Viktor Valverde", "invitation_code": "INV-20260116-28SPJ6", "bonus_credits": 50, "registration_type": "invitation_code"}	\N	\N	\N	\N	\N	2026-01-16 13:41:40.896251+01
28	\N	POST_/api/v1/auth/register-with-invitation	\N	\N	null	127.0.0.1	python-requests/2.32.5	POST	/api/v1/auth/register-with-invitation	200	2026-01-16 13:41:40.911787+01
29	4	LOGIN	\N	\N	{"email": "pwt.k1sqx1@f1stteam.hu", "role": "student", "success": true}	\N	\N	\N	\N	\N	2026-01-16 13:41:56.319674+01
30	4	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:41:56.562263+01
31	4	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:41:56.651507+01
32	4	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:42:05.015164+01
33	4	POST_/api/v1/coupons/apply	\N	\N	null	127.0.0.1	python-requests/2.32.5	POST	/api/v1/coupons/apply	200	2026-01-16 13:42:05.055176+01
34	4	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:42:05.063947+01
35	4	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:42:05.1+01
36	4	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:42:16.633618+01
37	4	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:42:16.68482+01
38	4	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:42:19.203287+01
39	4	POST_/specialization/unlock	\N	\N	null	127.0.0.1	python-requests/2.32.5	POST	/specialization/unlock	200	2026-01-16 13:42:19.243503+01
40	4	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:42:19.257898+01
41	4	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:42:19.336982+01
42	4	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:42:24.759904+01
43	4	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:42:24.80552+01
44	4	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:42:26.333439+01
45	4	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:42:26.378267+01
46	4	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:42:31.930657+01
47	4	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:42:32.911811+01
48	4	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:42:33.900641+01
49	4	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:42:34.612102+01
50	4	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:42:35.174255+01
51	4	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:42:36.009123+01
52	4	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:42:36.71169+01
53	4	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:42:37.292139+01
54	4	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:42:37.864782+01
56	4	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:42:39.266318+01
58	4	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:42:40.537334+01
60	4	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:42:41.944806+01
62	4	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:42:43.238998+01
64	4	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:42:44.379642+01
66	4	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:42:46.226154+01
68	4	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:42:57.964629+01
69	4	POST_/specialization/lfa-player/onboarding-submit	\N	\N	null	127.0.0.1	python-requests/2.32.5	POST	/specialization/lfa-player/onboarding-submit	303	2026-01-16 13:42:57.996987+01
71	4	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:42:58.086014+01
72	5	LOGIN	\N	\N	{"email": "pwt.p3t1k3@f1stteam.hu", "role": "student", "success": true}	\N	\N	\N	\N	\N	2026-01-16 13:43:13.485482+01
74	5	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:43:13.783868+01
55	4	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:42:38.43708+01
57	4	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:42:39.977147+01
59	4	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:42:41.110378+01
61	4	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:42:42.656983+01
63	4	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:42:43.80002+01
65	4	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:42:46.179636+01
67	4	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:42:54.404237+01
70	4	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:42:58.008097+01
73	5	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:43:13.698467+01
75	5	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:43:22.162914+01
76	5	POST_/api/v1/coupons/apply	\N	\N	null	127.0.0.1	python-requests/2.32.5	POST	/api/v1/coupons/apply	200	2026-01-16 13:43:22.199633+01
77	5	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:43:22.208935+01
78	5	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:43:22.251809+01
79	5	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:43:33.762327+01
80	5	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:43:33.809403+01
81	5	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:43:36.349536+01
82	5	POST_/specialization/unlock	\N	\N	null	127.0.0.1	python-requests/2.32.5	POST	/specialization/unlock	200	2026-01-16 13:43:36.373891+01
83	5	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:43:36.384742+01
84	5	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:43:36.450993+01
85	5	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:43:41.933613+01
86	5	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:43:41.983987+01
87	5	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:43:43.491994+01
88	5	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:43:43.534681+01
89	5	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:43:49.073061+01
90	5	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:43:49.789096+01
91	5	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:43:50.364147+01
92	5	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:43:51.215936+01
93	5	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:43:51.932611+01
94	5	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:43:52.75986+01
95	5	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:43:53.468216+01
96	5	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:43:54.032122+01
97	5	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:43:54.610979+01
98	5	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:43:55.173302+01
99	5	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:43:56.007558+01
100	5	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:43:56.711587+01
101	5	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:43:57.292148+01
102	5	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:43:57.861349+01
103	5	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:43:58.430624+01
104	5	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:43:59.260058+01
105	5	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:43:59.967926+01
106	5	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:44:00.542782+01
107	5	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:44:01.112256+01
108	5	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:44:01.67694+01
109	5	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:44:02.257903+01
110	5	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:44:03.073965+01
111	5	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:44:03.782002+01
112	5	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:44:04.36381+01
113	5	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:44:06.178384+01
114	5	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:44:06.219804+01
115	5	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:44:14.422389+01
116	5	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:44:17.976964+01
117	5	POST_/specialization/lfa-player/onboarding-submit	\N	\N	null	127.0.0.1	python-requests/2.32.5	POST	/specialization/lfa-player/onboarding-submit	303	2026-01-16 13:44:17.996999+01
118	5	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:44:18.007054+01
119	5	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:44:18.083292+01
120	6	LOGIN	\N	\N	{"email": "pwt.V4lv3rd3jr@f1stteam.hu", "role": "student", "success": true}	\N	\N	\N	\N	\N	2026-01-16 13:44:33.495915+01
121	6	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:44:33.715501+01
122	6	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:44:33.801588+01
123	6	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:44:42.162471+01
124	6	POST_/api/v1/coupons/apply	\N	\N	null	127.0.0.1	python-requests/2.32.5	POST	/api/v1/coupons/apply	200	2026-01-16 13:44:42.198615+01
126	6	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:44:42.241344+01
128	6	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:44:53.826671+01
131	6	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:44:56.377873+01
133	6	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:45:01.916014+01
135	6	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:45:03.480764+01
137	6	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:45:09.107869+01
139	6	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:45:10.407378+01
141	6	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:45:11.557912+01
143	6	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:45:13.098936+01
145	6	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:45:14.246961+01
147	6	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:45:15.390442+01
149	6	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:45:16.928051+01
151	6	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:45:18.06534+01
153	6	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:45:19.621067+01
155	6	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:45:21.023084+01
125	6	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:44:42.205989+01
127	6	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:44:53.782278+01
129	6	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:44:56.345877+01
130	6	POST_/specialization/unlock	\N	\N	null	127.0.0.1	python-requests/2.32.5	POST	/specialization/unlock	200	2026-01-16 13:44:56.368251+01
132	6	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:44:56.454321+01
134	6	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:45:01.957183+01
136	6	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:45:03.526707+01
138	6	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:45:09.830462+01
140	6	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:45:10.977705+01
142	6	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:45:12.399678+01
144	6	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:45:13.666973+01
146	6	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:45:14.808522+01
148	6	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:45:16.220995+01
150	6	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:45:17.495334+01
152	6	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:45:18.916424+01
154	6	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:45:20.194282+01
156	6	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:45:21.992534+01
157	6	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:45:22.699877+01
158	6	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:45:23.265553+01
159	6	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:45:23.841874+01
160	6	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:45:24.415753+01
161	6	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:45:26.23791+01
162	6	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:45:26.285705+01
163	6	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:45:34.483717+01
164	6	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:45:43.983344+01
165	6	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:45:44.278708+01
166	6	POST_/specialization/lfa-player/onboarding-submit	\N	\N	null	127.0.0.1	python-requests/2.32.5	POST	/specialization/lfa-player/onboarding-submit	303	2026-01-16 13:45:44.303027+01
167	6	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:45:44.314063+01
168	6	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-16 13:45:44.387034+01
169	6	GET_/api/v1/tournaments/available	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/tournaments/available	400	2026-01-16 13:45:44.41762+01
170	1	LOGIN	\N	\N	{"email": "admin@lfa.com", "role": "admin", "success": true}	\N	\N	\N	\N	\N	2026-01-17 08:36:20.664546+01
171	1	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-17 08:36:20.917153+01
172	1	GET_/api/v1/admin/locations/	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/admin/locations/	200	2026-01-17 08:36:20.997843+01
173	1	GET_/api/v1/admin/locations/2/campuses	location	2	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/admin/locations/2/campuses	200	2026-01-17 08:36:21.022689+01
174	1	GET_/api/v1/admin/locations/	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/admin/locations/	200	2026-01-17 08:36:33.259704+01
175	1	GET_/api/v1/admin/campuses/	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/admin/campuses/	307	2026-01-17 08:36:33.26812+01
176	1	GET_/api/v1/admin/campuses	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/admin/campuses	200	2026-01-17 08:36:33.281067+01
177	1	GET_/api/v1/admin/locations/	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/admin/locations/	200	2026-01-17 08:37:26.783372+01
178	1	GET_/api/v1/admin/campuses/	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/admin/campuses/	307	2026-01-17 08:37:26.807086+01
179	1	GET_/api/v1/admin/campuses	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/admin/campuses	200	2026-01-17 08:37:26.819317+01
180	1	GET_/api/v1/admin/locations/	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/admin/locations/	200	2026-01-17 08:37:50.709771+01
181	1	GET_/api/v1/admin/campuses/	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/admin/campuses/	307	2026-01-17 08:37:50.71652+01
182	1	GET_/api/v1/admin/campuses	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/admin/campuses	200	2026-01-17 08:37:50.728586+01
183	1	POST_/api/v1/tournament-types/1/estimate	tournament-type	1	null	127.0.0.1	python-requests/2.32.5	POST	/api/v1/tournament-types/1/estimate	200	2026-01-17 08:37:50.750326+01
184	1	POST_/api/v1/tournaments/generate	\N	\N	null	127.0.0.1	python-requests/2.32.5	POST	/api/v1/tournaments/generate	201	2026-01-17 08:37:50.816454+01
185	1	GET_/api/v1/semesters/1/enrollments	semester	1	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/semesters/1/enrollments	404	2026-01-17 08:37:50.858432+01
186	1	GET_/api/v1/admin/locations/	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/admin/locations/	200	2026-01-17 08:37:50.882014+01
187	1	GET_/api/v1/admin/campuses/	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/admin/campuses/	307	2026-01-17 08:37:50.889988+01
188	1	GET_/api/v1/admin/campuses	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/admin/campuses	200	2026-01-17 08:37:50.8996+01
189	1	POST_/api/v1/tournament-types/1/estimate	tournament-type	1	null	127.0.0.1	python-requests/2.32.5	POST	/api/v1/tournament-types/1/estimate	200	2026-01-17 08:37:50.9183+01
190	1	GET_/api/v1/semesters/1/enrollments	semester	1	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/semesters/1/enrollments	404	2026-01-17 08:38:10.087989+01
191	1	GET_/api/v1/admin/locations/	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/admin/locations/	200	2026-01-17 08:38:10.109439+01
192	1	GET_/api/v1/admin/campuses/	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/admin/campuses/	307	2026-01-17 08:38:10.11554+01
193	1	GET_/api/v1/admin/campuses	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/admin/campuses	200	2026-01-17 08:38:10.124534+01
194	1	POST_/api/v1/tournament-types/1/estimate	tournament-type	1	null	127.0.0.1	python-requests/2.32.5	POST	/api/v1/tournament-types/1/estimate	200	2026-01-17 08:38:10.142389+01
195	1	GET_/api/v1/semesters/1/enrollments	semester	1	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/semesters/1/enrollments	404	2026-01-17 08:38:17.557376+01
196	1	GET_/api/v1/admin/locations/	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/admin/locations/	200	2026-01-17 08:38:17.582972+01
197	1	GET_/api/v1/admin/campuses/	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/admin/campuses/	307	2026-01-17 08:38:17.589625+01
198	1	GET_/api/v1/admin/campuses	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/admin/campuses	200	2026-01-17 08:38:17.5981+01
199	1	POST_/api/v1/tournament-types/1/estimate	tournament-type	1	null	127.0.0.1	python-requests/2.32.5	POST	/api/v1/tournament-types/1/estimate	200	2026-01-17 08:38:17.615625+01
200	1	GET_/api/v1/semesters/1/enrollments	semester	1	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/semesters/1/enrollments	404	2026-01-17 08:38:40.670293+01
201	1	GET_/api/v1/admin/locations/	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/admin/locations/	200	2026-01-17 08:38:40.690735+01
202	1	GET_/api/v1/admin/campuses/	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/admin/campuses/	307	2026-01-17 08:38:40.697429+01
203	1	GET_/api/v1/admin/campuses	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/admin/campuses	200	2026-01-17 08:38:40.706076+01
204	1	POST_/api/v1/tournament-types/2/estimate	tournament-type	2	null	127.0.0.1	python-requests/2.32.5	POST	/api/v1/tournament-types/2/estimate	200	2026-01-17 08:38:40.733219+01
205	1	POST_/api/v1/tournaments/generate	\N	\N	null	127.0.0.1	python-requests/2.32.5	POST	/api/v1/tournaments/generate	201	2026-01-17 08:38:40.763966+01
206	1	GET_/api/v1/semesters/1/enrollments	semester	1	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/semesters/1/enrollments	404	2026-01-17 08:38:40.80116+01
207	1	GET_/api/v1/semesters/2/enrollments	semester	2	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/semesters/2/enrollments	404	2026-01-17 08:38:40.820094+01
208	1	GET_/api/v1/admin/locations/	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/admin/locations/	200	2026-01-17 08:38:40.83904+01
209	1	GET_/api/v1/admin/campuses/	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/admin/campuses/	307	2026-01-17 08:38:40.846215+01
210	1	GET_/api/v1/admin/campuses	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/admin/campuses	200	2026-01-17 08:38:40.85362+01
211	1	POST_/api/v1/tournament-types/2/estimate	tournament-type	2	null	127.0.0.1	python-requests/2.32.5	POST	/api/v1/tournament-types/2/estimate	200	2026-01-17 08:38:40.872091+01
212	1	GET_/api/v1/semesters/1/enrollments	semester	1	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/semesters/1/enrollments	404	2026-01-17 08:38:59.092951+01
213	1	GET_/api/v1/semesters/2/enrollments	semester	2	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/semesters/2/enrollments	404	2026-01-17 08:38:59.114786+01
214	1	GET_/api/v1/admin/locations/	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/admin/locations/	200	2026-01-17 08:38:59.133668+01
215	1	GET_/api/v1/admin/campuses/	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/admin/campuses/	307	2026-01-17 08:38:59.140547+01
216	1	GET_/api/v1/admin/campuses	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/admin/campuses	200	2026-01-17 08:38:59.148606+01
218	1	GET_/api/v1/semesters/1/enrollments	semester	1	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/semesters/1/enrollments	404	2026-01-17 08:39:05.740906+01
217	1	POST_/api/v1/tournament-types/2/estimate	tournament-type	2	null	127.0.0.1	python-requests/2.32.5	POST	/api/v1/tournament-types/2/estimate	200	2026-01-17 08:38:59.174231+01
219	1	GET_/api/v1/semesters/2/enrollments	semester	2	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/semesters/2/enrollments	404	2026-01-17 08:39:05.763305+01
220	1	GET_/api/v1/admin/locations/	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/admin/locations/	200	2026-01-17 08:39:05.78218+01
221	1	GET_/api/v1/admin/campuses/	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/admin/campuses/	307	2026-01-17 08:39:05.788614+01
224	1	GET_/api/v1/semesters/1/enrollments	semester	1	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/semesters/1/enrollments	404	2026-01-17 08:39:28.809863+01
228	1	GET_/api/v1/admin/campuses	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/admin/campuses	200	2026-01-17 08:39:28.872596+01
229	1	POST_/api/v1/tournament-types/3/estimate	tournament-type	3	null	127.0.0.1	python-requests/2.32.5	POST	/api/v1/tournament-types/3/estimate	200	2026-01-17 08:39:28.89056+01
231	1	GET_/api/v1/semesters/1/enrollments	semester	1	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/semesters/1/enrollments	404	2026-01-17 08:39:28.964959+01
233	1	GET_/api/v1/semesters/3/enrollments	semester	3	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/semesters/3/enrollments	404	2026-01-17 08:39:28.999172+01
234	1	GET_/api/v1/admin/locations/	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/admin/locations/	200	2026-01-17 08:39:29.017987+01
235	1	GET_/api/v1/admin/campuses/	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/admin/campuses/	307	2026-01-17 08:39:29.024527+01
238	1	GET_/api/v1/semesters/1/enrollments	semester	1	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/semesters/1/enrollments	404	2026-01-17 08:39:47.236121+01
240	1	GET_/api/v1/semesters/3/enrollments	semester	3	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/semesters/3/enrollments	404	2026-01-17 08:39:47.273814+01
241	1	GET_/api/v1/admin/locations/	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/admin/locations/	200	2026-01-17 08:39:47.290723+01
242	1	GET_/api/v1/admin/campuses/	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/admin/campuses/	307	2026-01-17 08:39:47.296644+01
245	1	GET_/api/v1/semesters/1/enrollments	semester	1	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/semesters/1/enrollments	404	2026-01-17 08:39:53.874658+01
247	1	GET_/api/v1/semesters/3/enrollments	semester	3	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/semesters/3/enrollments	404	2026-01-17 08:39:53.913703+01
248	1	GET_/api/v1/admin/locations/	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/admin/locations/	200	2026-01-17 08:39:53.932365+01
249	1	GET_/api/v1/admin/campuses/	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/admin/campuses/	307	2026-01-17 08:39:53.938631+01
252	1	GET_/api/v1/semesters/1/enrollments	semester	1	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/semesters/1/enrollments	404	2026-01-17 08:40:16.967261+01
254	1	GET_/api/v1/semesters/3/enrollments	semester	3	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/semesters/3/enrollments	404	2026-01-17 08:40:17.002242+01
255	1	GET_/api/v1/admin/locations/	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/admin/locations/	200	2026-01-17 08:40:17.021785+01
256	1	GET_/api/v1/admin/campuses/	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/admin/campuses/	307	2026-01-17 08:40:17.028478+01
259	1	POST_/api/v1/tournaments/generate	\N	\N	null	127.0.0.1	python-requests/2.32.5	POST	/api/v1/tournaments/generate	201	2026-01-17 08:40:17.084737+01
261	1	GET_/api/v1/semesters/2/enrollments	semester	2	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/semesters/2/enrollments	404	2026-01-17 08:40:17.142191+01
263	1	GET_/api/v1/semesters/4/enrollments	semester	4	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/semesters/4/enrollments	404	2026-01-17 08:40:17.172644+01
265	1	GET_/api/v1/admin/locations/	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/admin/locations/	200	2026-01-17 08:40:17.204943+01
266	1	GET_/api/v1/admin/campuses/	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/admin/campuses/	307	2026-01-17 08:40:17.211706+01
222	1	GET_/api/v1/admin/campuses	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/admin/campuses	200	2026-01-17 08:39:05.796328+01
223	1	POST_/api/v1/tournament-types/2/estimate	tournament-type	2	null	127.0.0.1	python-requests/2.32.5	POST	/api/v1/tournament-types/2/estimate	200	2026-01-17 08:39:05.814776+01
225	1	GET_/api/v1/semesters/2/enrollments	semester	2	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/semesters/2/enrollments	404	2026-01-17 08:39:28.837255+01
226	1	GET_/api/v1/admin/locations/	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/admin/locations/	200	2026-01-17 08:39:28.857013+01
227	1	GET_/api/v1/admin/campuses/	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/admin/campuses/	307	2026-01-17 08:39:28.864276+01
230	1	POST_/api/v1/tournaments/generate	\N	\N	null	127.0.0.1	python-requests/2.32.5	POST	/api/v1/tournaments/generate	201	2026-01-17 08:39:28.92005+01
232	1	GET_/api/v1/semesters/2/enrollments	semester	2	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/semesters/2/enrollments	404	2026-01-17 08:39:28.983452+01
236	1	GET_/api/v1/admin/campuses	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/admin/campuses	200	2026-01-17 08:39:29.032056+01
237	1	POST_/api/v1/tournament-types/3/estimate	tournament-type	3	null	127.0.0.1	python-requests/2.32.5	POST	/api/v1/tournament-types/3/estimate	200	2026-01-17 08:39:29.049614+01
239	1	GET_/api/v1/semesters/2/enrollments	semester	2	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/semesters/2/enrollments	404	2026-01-17 08:39:47.257806+01
243	1	GET_/api/v1/admin/campuses	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/admin/campuses	200	2026-01-17 08:39:47.304403+01
244	1	POST_/api/v1/tournament-types/3/estimate	tournament-type	3	null	127.0.0.1	python-requests/2.32.5	POST	/api/v1/tournament-types/3/estimate	200	2026-01-17 08:39:47.321882+01
246	1	GET_/api/v1/semesters/2/enrollments	semester	2	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/semesters/2/enrollments	404	2026-01-17 08:39:53.897093+01
250	1	GET_/api/v1/admin/campuses	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/admin/campuses	200	2026-01-17 08:39:53.946495+01
251	1	POST_/api/v1/tournament-types/3/estimate	tournament-type	3	null	127.0.0.1	python-requests/2.32.5	POST	/api/v1/tournament-types/3/estimate	200	2026-01-17 08:39:53.963725+01
253	1	GET_/api/v1/semesters/2/enrollments	semester	2	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/semesters/2/enrollments	404	2026-01-17 08:40:16.988005+01
257	1	GET_/api/v1/admin/campuses	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/admin/campuses	200	2026-01-17 08:40:17.037256+01
258	1	POST_/api/v1/tournament-types/1/estimate	tournament-type	1	null	127.0.0.1	python-requests/2.32.5	POST	/api/v1/tournament-types/1/estimate	200	2026-01-17 08:40:17.056027+01
260	1	GET_/api/v1/semesters/1/enrollments	semester	1	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/semesters/1/enrollments	404	2026-01-17 08:40:17.127911+01
262	1	GET_/api/v1/semesters/3/enrollments	semester	3	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/semesters/3/enrollments	404	2026-01-17 08:40:17.158292+01
264	1	GET_/api/v1/users/	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/	200	2026-01-17 08:40:17.195909+01
267	1	GET_/api/v1/admin/campuses	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/admin/campuses	200	2026-01-17 08:40:17.218377+01
268	1	POST_/api/v1/tournament-types/1/estimate	tournament-type	1	null	127.0.0.1	python-requests/2.32.5	POST	/api/v1/tournament-types/1/estimate	200	2026-01-17 08:40:17.238361+01
269	1	GET_/api/v1/semesters/1/enrollments	semester	1	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/semesters/1/enrollments	404	2026-01-17 08:40:46.970835+01
270	1	GET_/api/v1/semesters/2/enrollments	semester	2	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/semesters/2/enrollments	404	2026-01-17 08:40:46.993534+01
271	1	GET_/api/v1/semesters/3/enrollments	semester	3	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/semesters/3/enrollments	404	2026-01-17 08:40:47.010693+01
272	1	GET_/api/v1/semesters/4/enrollments	semester	4	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/semesters/4/enrollments	404	2026-01-17 08:40:47.025733+01
273	1	GET_/api/v1/users/	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/	200	2026-01-17 08:40:47.037726+01
274	1	GET_/api/v1/admin/locations/	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/admin/locations/	200	2026-01-17 08:40:47.048056+01
275	1	GET_/api/v1/admin/campuses/	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/admin/campuses/	307	2026-01-17 08:40:47.054469+01
276	1	GET_/api/v1/admin/campuses	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/admin/campuses	200	2026-01-17 08:40:47.063557+01
277	1	POST_/api/v1/tournament-types/1/estimate	tournament-type	1	null	127.0.0.1	python-requests/2.32.5	POST	/api/v1/tournament-types/1/estimate	200	2026-01-17 08:40:47.08074+01
278	1	GET_/api/v1/semesters/1/enrollments	semester	1	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/semesters/1/enrollments	404	2026-01-17 08:41:10.061825+01
279	1	GET_/api/v1/semesters/2/enrollments	semester	2	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/semesters/2/enrollments	404	2026-01-17 08:41:10.078921+01
280	1	GET_/api/v1/semesters/3/enrollments	semester	3	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/semesters/3/enrollments	404	2026-01-17 08:41:10.09572+01
281	1	GET_/api/v1/semesters/4/enrollments	semester	4	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/semesters/4/enrollments	404	2026-01-17 08:41:10.111534+01
282	1	GET_/api/v1/users/	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/	200	2026-01-17 08:41:10.122564+01
283	1	GET_/api/v1/admin/locations/	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/admin/locations/	200	2026-01-17 08:41:10.131724+01
284	1	GET_/api/v1/admin/campuses/	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/admin/campuses/	307	2026-01-17 08:41:10.139224+01
285	1	GET_/api/v1/admin/campuses	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/admin/campuses	200	2026-01-17 08:41:10.147384+01
286	1	POST_/api/v1/tournament-types/2/estimate	tournament-type	2	null	127.0.0.1	python-requests/2.32.5	POST	/api/v1/tournament-types/2/estimate	200	2026-01-17 08:41:10.165597+01
287	1	POST_/api/v1/tournaments/generate	\N	\N	null	127.0.0.1	python-requests/2.32.5	POST	/api/v1/tournaments/generate	201	2026-01-17 08:41:10.192863+01
288	1	GET_/api/v1/semesters/1/enrollments	semester	1	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/semesters/1/enrollments	404	2026-01-17 08:41:10.232127+01
289	1	GET_/api/v1/semesters/2/enrollments	semester	2	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/semesters/2/enrollments	404	2026-01-17 08:41:10.249197+01
290	1	GET_/api/v1/semesters/3/enrollments	semester	3	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/semesters/3/enrollments	404	2026-01-17 08:41:10.263981+01
291	1	GET_/api/v1/semesters/4/enrollments	semester	4	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/semesters/4/enrollments	404	2026-01-17 08:41:10.278759+01
292	1	GET_/api/v1/users/	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/	200	2026-01-17 08:41:10.29012+01
293	1	GET_/api/v1/semesters/5/enrollments	semester	5	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/semesters/5/enrollments	404	2026-01-17 08:41:10.297236+01
294	1	GET_/api/v1/users/	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/	200	2026-01-17 08:41:10.309152+01
297	1	GET_/api/v1/admin/campuses	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/admin/campuses	200	2026-01-17 08:41:10.33346+01
298	1	POST_/api/v1/tournament-types/2/estimate	tournament-type	2	null	127.0.0.1	python-requests/2.32.5	POST	/api/v1/tournament-types/2/estimate	200	2026-01-17 08:41:10.350868+01
300	1	GET_/api/v1/semesters/2/enrollments	semester	2	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/semesters/2/enrollments	404	2026-01-17 08:42:35.496235+01
302	1	GET_/api/v1/semesters/4/enrollments	semester	4	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/semesters/4/enrollments	404	2026-01-17 08:42:35.534107+01
305	1	GET_/api/v1/users/	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/	200	2026-01-17 08:42:35.570336+01
308	1	GET_/api/v1/admin/campuses	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/admin/campuses	200	2026-01-17 08:42:35.596571+01
309	1	POST_/api/v1/tournament-types/3/estimate	tournament-type	3	null	127.0.0.1	python-requests/2.32.5	POST	/api/v1/tournament-types/3/estimate	200	2026-01-17 08:42:35.618687+01
311	1	GET_/api/v1/semesters/1/enrollments	semester	1	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/semesters/1/enrollments	404	2026-01-17 08:42:35.708894+01
313	1	GET_/api/v1/semesters/3/enrollments	semester	3	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/semesters/3/enrollments	404	2026-01-17 08:42:35.744326+01
315	1	GET_/api/v1/users/	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/	200	2026-01-17 08:42:35.771624+01
316	1	GET_/api/v1/semesters/5/enrollments	semester	5	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/semesters/5/enrollments	404	2026-01-17 08:42:35.781784+01
319	1	GET_/api/v1/users/	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/	200	2026-01-17 08:42:35.811266+01
322	1	GET_/api/v1/admin/campuses	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/admin/campuses	200	2026-01-17 08:42:35.835363+01
323	1	POST_/api/v1/tournament-types/3/estimate	tournament-type	3	null	127.0.0.1	python-requests/2.32.5	POST	/api/v1/tournament-types/3/estimate	200	2026-01-17 08:42:35.853944+01
324	1	LOGIN	\N	\N	{"email": "admin@lfa.com", "role": "admin", "success": true}	\N	\N	\N	\N	\N	2026-01-17 08:42:41.040974+01
328	3	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-17 08:45:09.249356+01
331	3	GET_/api/v1/tournaments/2/my-application	tournament	2	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/tournaments/2/my-application	404	2026-01-17 08:45:09.541522+01
333	3	GET_/api/v1/tournaments/4/my-application	tournament	4	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/tournaments/4/my-application	404	2026-01-17 08:45:09.555933+01
335	3	GET_/api/v1/tournaments/6/my-application	tournament	6	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/tournaments/6/my-application	404	2026-01-17 08:45:09.570126+01
337	3	LICENSE_VIEWED	user	3	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/licenses/user/3	200	2026-01-17 08:45:10.660474+01
340	3	LICENSE_VIEWED	user	3	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/licenses/user/3	200	2026-01-17 08:45:24.637254+01
341	3	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-17 08:45:24.662498+01
343	3	LICENSE_VIEWED	user	3	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/licenses/user/3	200	2026-01-17 08:45:28.51444+01
344	3	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-17 08:45:28.540513+01
345	3	POST_/api/v1/tournaments/1/instructor-applications	tournament	1	null	127.0.0.1	python-requests/2.32.5	POST	/api/v1/tournaments/1/instructor-applications	200	2026-01-17 08:45:28.576507+01
347	3	GET_/api/v1/tournaments/2/my-application	tournament	2	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/tournaments/2/my-application	404	2026-01-17 08:45:30.748776+01
349	3	GET_/api/v1/tournaments/4/my-application	tournament	4	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/tournaments/4/my-application	404	2026-01-17 08:45:30.763321+01
351	3	GET_/api/v1/tournaments/6/my-application	tournament	6	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/tournaments/6/my-application	404	2026-01-17 08:45:30.777247+01
353	3	LICENSE_VIEWED	user	3	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/licenses/user/3	200	2026-01-17 08:45:30.895626+01
356	3	LICENSE_VIEWED	user	3	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/licenses/user/3	200	2026-01-17 08:45:33.68719+01
357	3	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-17 08:45:33.715211+01
295	1	GET_/api/v1/admin/locations/	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/admin/locations/	200	2026-01-17 08:41:10.318972+01
296	1	GET_/api/v1/admin/campuses/	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/admin/campuses/	307	2026-01-17 08:41:10.325848+01
299	1	GET_/api/v1/semesters/1/enrollments	semester	1	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/semesters/1/enrollments	404	2026-01-17 08:42:35.47489+01
301	1	GET_/api/v1/semesters/3/enrollments	semester	3	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/semesters/3/enrollments	404	2026-01-17 08:42:35.513643+01
303	1	GET_/api/v1/users/	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/	200	2026-01-17 08:42:35.549668+01
304	1	GET_/api/v1/semesters/5/enrollments	semester	5	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/semesters/5/enrollments	404	2026-01-17 08:42:35.556871+01
306	1	GET_/api/v1/admin/locations/	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/admin/locations/	200	2026-01-17 08:42:35.580065+01
307	1	GET_/api/v1/admin/campuses/	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/admin/campuses/	307	2026-01-17 08:42:35.586859+01
310	1	POST_/api/v1/tournaments/generate	\N	\N	null	127.0.0.1	python-requests/2.32.5	POST	/api/v1/tournaments/generate	201	2026-01-17 08:42:35.6512+01
312	1	GET_/api/v1/semesters/2/enrollments	semester	2	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/semesters/2/enrollments	404	2026-01-17 08:42:35.72962+01
314	1	GET_/api/v1/semesters/4/enrollments	semester	4	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/semesters/4/enrollments	404	2026-01-17 08:42:35.759393+01
317	1	GET_/api/v1/users/	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/	200	2026-01-17 08:42:35.792674+01
318	1	GET_/api/v1/semesters/6/enrollments	semester	6	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/semesters/6/enrollments	404	2026-01-17 08:42:35.799888+01
320	1	GET_/api/v1/admin/locations/	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/admin/locations/	200	2026-01-17 08:42:35.820752+01
321	1	GET_/api/v1/admin/campuses/	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/admin/campuses/	307	2026-01-17 08:42:35.827201+01
325	1	LOGIN	\N	\N	{"email": "admin@lfa.com", "role": "admin", "success": true}	\N	\N	\N	\N	\N	2026-01-17 08:45:05.999372+01
326	3	LOGIN	\N	\N	{"email": "grandmaster@lfa.com", "role": "instructor", "success": true}	\N	\N	\N	\N	\N	2026-01-17 08:45:06.396696+01
327	3	LOGIN	\N	\N	{"email": "grandmaster@lfa.com", "role": "instructor", "success": true}	\N	\N	\N	\N	\N	2026-01-17 08:45:09.040784+01
329	3	LICENSE_VIEWED	user	3	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/licenses/user/3	200	2026-01-17 08:45:09.501438+01
330	3	GET_/api/v1/tournaments/1/my-application	tournament	1	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/tournaments/1/my-application	404	2026-01-17 08:45:09.53162+01
332	3	GET_/api/v1/tournaments/3/my-application	tournament	3	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/tournaments/3/my-application	404	2026-01-17 08:45:09.548572+01
334	3	GET_/api/v1/tournaments/5/my-application	tournament	5	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/tournaments/5/my-application	404	2026-01-17 08:45:09.562803+01
336	3	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-17 08:45:10.504296+01
338	3	LICENSE_VIEWED	user	3	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/licenses/user/3	200	2026-01-17 08:45:24.474934+01
339	3	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-17 08:45:24.501586+01
342	3	LICENSE_VIEWED	user	3	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/licenses/user/3	200	2026-01-17 08:45:24.772945+01
346	3	LICENSE_VIEWED	user	3	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/licenses/user/3	200	2026-01-17 08:45:30.715929+01
348	3	GET_/api/v1/tournaments/3/my-application	tournament	3	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/tournaments/3/my-application	404	2026-01-17 08:45:30.756478+01
350	3	GET_/api/v1/tournaments/5/my-application	tournament	5	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/tournaments/5/my-application	404	2026-01-17 08:45:30.770206+01
352	3	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-17 08:45:30.786371+01
354	3	LICENSE_VIEWED	user	3	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/licenses/user/3	200	2026-01-17 08:45:33.529763+01
355	3	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-17 08:45:33.559921+01
358	3	LICENSE_VIEWED	user	3	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/licenses/user/3	200	2026-01-17 08:45:33.835492+01
359	3	LICENSE_VIEWED	user	3	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/licenses/user/3	200	2026-01-17 08:45:37.587796+01
360	3	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-17 08:45:37.615685+01
361	3	POST_/api/v1/tournaments/2/instructor-applications	tournament	2	null	127.0.0.1	python-requests/2.32.5	POST	/api/v1/tournaments/2/instructor-applications	200	2026-01-17 08:45:37.664819+01
362	3	LICENSE_VIEWED	user	3	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/licenses/user/3	200	2026-01-17 08:45:39.801833+01
363	3	GET_/api/v1/tournaments/3/my-application	tournament	3	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/tournaments/3/my-application	404	2026-01-17 08:45:39.841567+01
364	3	GET_/api/v1/tournaments/4/my-application	tournament	4	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/tournaments/4/my-application	404	2026-01-17 08:45:39.849429+01
365	3	GET_/api/v1/tournaments/5/my-application	tournament	5	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/tournaments/5/my-application	404	2026-01-17 08:45:39.859917+01
366	3	GET_/api/v1/tournaments/6/my-application	tournament	6	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/tournaments/6/my-application	404	2026-01-17 08:45:39.869514+01
367	3	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-17 08:45:39.880088+01
368	3	LICENSE_VIEWED	user	3	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/licenses/user/3	200	2026-01-17 08:45:39.992899+01
369	3	LICENSE_VIEWED	user	3	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/licenses/user/3	200	2026-01-17 08:45:42.216956+01
370	3	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-17 08:45:42.251001+01
371	3	LICENSE_VIEWED	user	3	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/licenses/user/3	200	2026-01-17 08:45:42.365592+01
372	3	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-17 08:45:42.393386+01
373	3	LICENSE_VIEWED	user	3	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/licenses/user/3	200	2026-01-17 08:45:42.511243+01
374	3	LICENSE_VIEWED	user	3	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/licenses/user/3	200	2026-01-17 08:45:46.279607+01
375	3	GET_/api/v1/users/me	\N	\N	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/users/me	200	2026-01-17 08:45:46.305489+01
376	3	POST_/api/v1/tournaments/3/instructor-applications	tournament	3	null	127.0.0.1	python-requests/2.32.5	POST	/api/v1/tournaments/3/instructor-applications	200	2026-01-17 08:45:46.334874+01
377	1	POST_/api/v1/tournaments/3/instructor-applications/3/approve	tournament	3	null	127.0.0.1	python-requests/2.32.5	POST	/api/v1/tournaments/3/instructor-applications/3/approve	200	2026-01-17 08:45:48.322114+01
379	1	POST_/api/v1/tournaments/1/instructor-applications/1/approve	tournament	1	null	127.0.0.1	python-requests/2.32.5	POST	/api/v1/tournaments/1/instructor-applications/1/approve	200	2026-01-17 08:45:48.362223+01
378	1	POST_/api/v1/tournaments/2/instructor-applications/2/approve	tournament	2	null	127.0.0.1	python-requests/2.32.5	POST	/api/v1/tournaments/2/instructor-applications/2/approve	200	2026-01-17 08:45:48.344173+01
380	3	POST_/api/v1/tournaments/1/instructor/accept	tournament	1	null	127.0.0.1	python-requests/2.32.5	POST	/api/v1/tournaments/1/instructor/accept	400	2026-01-17 08:45:48.373199+01
381	3	LICENSE_VIEWED	user	3	null	127.0.0.1	python-requests/2.32.5	GET	/api/v1/licenses/user/3	200	2026-01-17 08:45:48.457918+01
\.
...
1	1	Budapest Main Campus	Budapest Sports Complex	Budapest Sports Street 1	\N	t	2026-01-16 12:39:12.132033	2026-01-16 12:39:12.13204
2	2	Vienna Main Campus	Vienna Sports Complex	Vienna Sports Street 1	\N	t	2026-01-16 12:39:12.137021	2026-01-16 12:39:12.137023
3	3	Bratislava Main Campus	Bratislava Sports Complex	Bratislava Sports Street 1	\N	t	2026-01-16 12:39:12.138163	2026-01-16 12:39:12.138165
\.
...
1	1	4	50	2026-01-16 13:42:05.039781+01
2	2	5	50	2026-01-16 13:43:22.18951+01
3	3	6	50	2026-01-16 13:44:42.187761+01
\.
...
1	E2E-BONUS-50-USER1	BONUS_CREDITS	50	E2E onboarding test: +50 bonus credits	t	\N	1	1	f	f	2026-01-16 13:39:12.794025+01	2026-01-16 13:42:05.034731+01
2	E2E-BONUS-50-USER2	BONUS_CREDITS	50	E2E onboarding test: +50 bonus credits	t	\N	1	1	f	f	2026-01-16 13:39:12.819552+01	2026-01-16 13:43:22.187149+01
3	E2E-BONUS-50-USER3	BONUS_CREDITS	50	E2E onboarding test: +50 bonus credits	t	\N	1	1	f	f	2026-01-16 13:39:12.830472+01	2026-01-16 13:44:42.185215+01
\.
...
1	\N	22	PURCHASE	-100	0	Unlocked specialization: LFA_FOOTBALL_PLAYER	\N	\N	2026-01-16 12:42:19.230514
2	\N	23	PURCHASE	-100	0	Unlocked specialization: LFA_FOOTBALL_PLAYER	\N	\N	2026-01-16 12:43:36.368444
3	\N	24	PURCHASE	-100	0	Unlocked specialization: LFA_FOOTBALL_PLAYER	\N	\N	2026-01-16 12:44:56.363591
\.
...
3	3	3	\N	\N	ACCEPTED	2026-01-17 08:45:46.327997+01	2026-01-17 07:45:48.294617+01	\N	I am interested in leading this tournament as the master instructor.	Application approved - looking forward to working with you!	0
2	2	3	\N	\N	ACCEPTED	2026-01-17 08:45:37.653022+01	2026-01-17 07:45:48.331844+01	\N	I am interested in leading this tournament as the master instructor.	Application approved - looking forward to working with you!	0
1	1	3	\N	\N	ACCEPTED	2026-01-17 08:45:28.564707+01	2026-01-17 07:45:48.353034+01	\N	I am interested in leading this tournament as the master instructor.	Application approved - looking forward to working with you!	0
\.
...
1	INV-20260116-7GZS5W	E2E Test - First Team Player 1 - Pre Category	\N	50	t	4	2026-01-16 13:40:35.641281+01	1	2026-01-16 13:39:31.399334+01	2026-01-23 13:39:31.364896+01	\N
2	INV-20260116-GL1D2N	E2E Test - First Team Player 2 - Youth Category	\N	50	t	5	2026-01-16 13:41:08.463399+01	1	2026-01-16 13:39:44.755961+01	2026-01-23 13:39:44.751104+01	\N
3	INV-20260116-28SPJ6	E2E Test - First Team Player 3 - Amateur Category	\N	50	t	6	2026-01-16 13:41:40.886783+01	1	2026-01-16 13:39:58.145156+01	2026-01-23 13:39:58.137438+01	\N
\.
...
1	Budapest Center	Budapest	1011	Hungary	HU	BDPST	\N	Váci utca 123	\N	t	CENTER	2026-01-16 12:39:12.128859	2026-01-16 12:39:12.128869
2	Vienna Academy	Vienna	1010	Austria	AT	VIE	\N	Stephansplatz 1	\N	t	CENTER	2026-01-16 12:39:12.136388	2026-01-16 12:39:12.13639
3	Bratislava Training Center	Bratislava	81101	Slovakia	SK	BTS	\N	Hviezdoslavovo námestie 1	\N	t	PARTNER	2026-01-16 12:39:12.137583	2026-01-16 12:39:12.137585
\.
...
1	3	🎉 Tournament Application Approved: 🇸🇰 SK - "Bratislava SK Group+KO 20260117083616" - BTS	Congratulations! Your application to lead '🇸🇰 SK - "Bratislava SK Group+KO 20260117083616" - BTS' has been approved!\n\nAdmin message: Application approved - looking forward to working with you!\n\nYou are now assigned as the master instructor for this tournament. You can view tournament details in your Dashboard.	TOURNAMENT_APPLICATION_APPROVED	f	\N	\N	2026-01-17 08:45:48.312795	\N	/instructor-dashboard?tab=my-applications	3	3
2	3	🎉 Tournament Application Approved: 🇭🇺 HU - "Vienna AT Knockout 20260117083616" - BDPST	Congratulations! Your application to lead '🇭🇺 HU - "Vienna AT Knockout 20260117083616" - BDPST' has been approved!\n\nAdmin message: Application approved - looking forward to working with you!\n\nYou are now assigned as the master instructor for this tournament. You can view tournament details in your Dashboard.	TOURNAMENT_APPLICATION_APPROVED	f	\N	\N	2026-01-17 08:45:48.338621	\N	/instructor-dashboard?tab=my-applications	2	2
3	3	🎉 Tournament Application Approved: 🇦🇹 AT - "Budapest HU League 20260117083616" - VIE	Congratulations! Your application to lead '🇦🇹 AT - "Budapest HU League 20260117083616" - VIE' has been approved!\n\nAdmin message: Application approved - looking forward to working with you!\n\nYou are now assigned as the master instructor for this tournament. You can view tournament details in your Dashboard.	TOURNAMENT_APPLICATION_APPROVED	f	\N	\N	2026-01-17 08:45:48.357661	\N	/instructor-dashboard?tab=my-applications	1	1
\.
...
4	TOURN-20260118-004	🇦🇹 AT - "Budapest HU League INV 20260117083616" - VIE	2026-01-18	2026-01-18	SEEKING_INSTRUCTOR	SEEKING_INSTRUCTOR	t	500	2026-01-17 08:40:17.079338	2026-01-17 08:40:17.079341	\N	LFA_FOOTBALL_PLAYER	AMATEUR	\N	\N	2	2	\N	\N	\N	1	\N	INDIVIDUAL	f	f	\N	OPEN_ASSIGNMENT	8	default	{"version": "1.0.0", "description": "Standard reward policy for all tournament types and specializations", "policy_name": "default", "specializations": ["LFA_FOOTBALL_PLAYER", "LFA_COACH", "INTERNSHIP", "GANCUJU_PLAYER"], "placement_rewards": {"1ST": {"xp": 500, "credits": 100}, "2ND": {"xp": 300, "credits": 50}, "3RD": {"xp": 200, "credits": 25}, "PARTICIPANT": {"xp": 50, "credits": 0}}, "participation_rewards": {"session_attendance": {"xp": 10, "credits": 0}}, "applies_to_all_tournament_types": true}
5	TOURN-20260118-005	🇦🇹 AT - "Vienna AT Knockout INV 20260117083616" - VIE	2026-01-18	2026-01-18	SEEKING_INSTRUCTOR	SEEKING_INSTRUCTOR	t	500	2026-01-17 08:41:10.186553	2026-01-17 08:41:10.186556	\N	LFA_FOOTBALL_PLAYER	AMATEUR	\N	\N	2	2	\N	\N	\N	2	\N	INDIVIDUAL	f	f	\N	OPEN_ASSIGNMENT	8	default	{"version": "1.0.0", "description": "Standard reward policy for all tournament types and specializations", "policy_name": "default", "specializations": ["LFA_FOOTBALL_PLAYER", "LFA_COACH", "INTERNSHIP", "GANCUJU_PLAYER"], "placement_rewards": {"1ST": {"xp": 500, "credits": 100}, "2ND": {"xp": 300, "credits": 50}, "3RD": {"xp": 200, "credits": 25}, "PARTICIPANT": {"xp": 50, "credits": 0}}, "participation_rewards": {"session_attendance": {"xp": 10, "credits": 0}}, "applies_to_all_tournament_types": true}
6	TOURN-20260118-006	🇦🇹 AT - "Bratislava SK Group+KO INV 20260117083616" - VIE	2026-01-18	2026-01-18	SEEKING_INSTRUCTOR	SEEKING_INSTRUCTOR	t	500	2026-01-17 08:42:35.640917	2026-01-17 08:42:35.640922	\N	LFA_FOOTBALL_PLAYER	AMATEUR	\N	\N	2	2	\N	\N	\N	3	\N	INDIVIDUAL	f	f	\N	OPEN_ASSIGNMENT	8	default	{"version": "1.0.0", "description": "Standard reward policy for all tournament types and specializations", "policy_name": "default", "specializations": ["LFA_FOOTBALL_PLAYER", "LFA_COACH", "INTERNSHIP", "GANCUJU_PLAYER"], "placement_rewards": {"1ST": {"xp": 500, "credits": 100}, "2ND": {"xp": 300, "credits": 50}, "3RD": {"xp": 200, "credits": 25}, "PARTICIPANT": {"xp": 50, "credits": 0}}, "participation_rewards": {"session_attendance": {"xp": 10, "credits": 0}}, "applies_to_all_tournament_types": true}
3	TOURN-20260118-003	🇸🇰 SK - "Bratislava SK Group+KO 20260117083616" - BTS	2026-01-18	2026-01-18	SEEKING_INSTRUCTOR	INSTRUCTOR_CONFIRMED	t	500	2026-01-17 08:39:28.913851	2026-01-17 08:45:48.304405	3	LFA_FOOTBALL_PLAYER	AMATEUR	\N	\N	3	3	\N	\N	\N	3	\N	INDIVIDUAL	f	f	\N	APPLICATION_BASED	8	default	{"version": "1.0.0", "description": "Standard reward policy for all tournament types and specializations", "policy_name": "default", "specializations": ["LFA_FOOTBALL_PLAYER", "LFA_COACH", "INTERNSHIP", "GANCUJU_PLAYER"], "placement_rewards": {"1ST": {"xp": 500, "credits": 100}, "2ND": {"xp": 300, "credits": 50}, "3RD": {"xp": 200, "credits": 25}, "PARTICIPANT": {"xp": 50, "credits": 0}}, "participation_rewards": {"session_attendance": {"xp": 10, "credits": 0}}, "applies_to_all_tournament_types": true}
2	TOURN-20260118-002	🇭🇺 HU - "Vienna AT Knockout 20260117083616" - BDPST	2026-01-18	2026-01-18	SEEKING_INSTRUCTOR	INSTRUCTOR_CONFIRMED	t	500	2026-01-17 08:38:40.757638	2026-01-17 08:45:48.334143	3	LFA_FOOTBALL_PLAYER	AMATEUR	\N	\N	1	1	\N	\N	\N	2	\N	INDIVIDUAL	f	f	\N	APPLICATION_BASED	8	default	{"version": "1.0.0", "description": "Standard reward policy for all tournament types and specializations", "policy_name": "default", "specializations": ["LFA_FOOTBALL_PLAYER", "LFA_COACH", "INTERNSHIP", "GANCUJU_PLAYER"], "placement_rewards": {"1ST": {"xp": 500, "credits": 100}, "2ND": {"xp": 300, "credits": 50}, "3RD": {"xp": 200, "credits": 25}, "PARTICIPANT": {"xp": 50, "credits": 0}}, "participation_rewards": {"session_attendance": {"xp": 10, "credits": 0}}, "applies_to_all_tournament_types": true}
1	TOURN-20260118-001	🇦🇹 AT - "Budapest HU League 20260117083616" - VIE	2026-01-18	2026-01-18	SEEKING_INSTRUCTOR	INSTRUCTOR_CONFIRMED	t	500	2026-01-17 08:37:50.798671	2026-01-17 08:45:48.354363	3	LFA_FOOTBALL_PLAYER	AMATEUR	\N	\N	2	2	\N	\N	\N	1	\N	INDIVIDUAL	f	f	\N	APPLICATION_BASED	8	default	{"version": "1.0.0", "description": "Standard reward policy for all tournament types and specializations", "policy_name": "default", "specializations": ["LFA_FOOTBALL_PLAYER", "LFA_COACH", "INTERNSHIP", "GANCUJU_PLAYER"], "placement_rewards": {"1ST": {"xp": 500, "credits": 100}, "2ND": {"xp": 300, "credits": 50}, "3RD": {"xp": 200, "credits": 25}, "PARTICIPANT": {"xp": 50, "credits": 0}}, "participation_rewards": {"session_attendance": {"xp": 10, "credits": 0}}, "applies_to_all_tournament_types": true}
\.
...
1	3	SEEKING_INSTRUCTOR	INSTRUCTOR_CONFIRMED	1	Admin approved instructor application from Grand Master - automatically assigned	{"application_id": 3, "instructor_id": 3, "instructor_name": "Grand Master", "assignment_type": "APPLICATION_BASED"}	2026-01-17 07:45:48.289456
2	2	SEEKING_INSTRUCTOR	INSTRUCTOR_CONFIRMED	1	Admin approved instructor application from Grand Master - automatically assigned	{"application_id": 2, "instructor_id": 3, "instructor_name": "Grand Master", "assignment_type": "APPLICATION_BASED"}	2026-01-17 07:45:48.329824
3	1	SEEKING_INSTRUCTOR	INSTRUCTOR_CONFIRMED	1	Admin approved instructor application from Grand Master - automatically assigned	{"application_id": 1, "instructor_id": 3, "instructor_name": "Grand Master", "assignment_type": "APPLICATION_BASED"}	2026-01-17 07:45:48.350764
\.
...
1	3	LFA_FOOTBALL_PLAYER	1	1	2026-01-16 12:39:12.117776	\N	\N	\N	t	2026-01-16 12:39:12.117785	t	\N	t	\N	\N	\N	1000	\N	\N	\N	\N	\N	\N	\N	0	0	\N	2026-01-16 13:39:12.119735	2026-01-16 13:39:12.119737
2	3	LFA_FOOTBALL_PLAYER	2	2	2026-01-16 12:39:12.117851	\N	\N	\N	t	2026-01-16 12:39:12.117853	t	\N	t	\N	\N	\N	1000	\N	\N	\N	\N	\N	\N	\N	0	0	\N	2026-01-16 13:39:12.11974	2026-01-16 13:39:12.11974
3	3	LFA_FOOTBALL_PLAYER	3	3	2026-01-16 12:39:12.117882	\N	\N	\N	t	2026-01-16 12:39:12.117883	t	\N	t	\N	\N	\N	1000	\N	\N	\N	\N	\N	\N	\N	0	0	\N	2026-01-16 13:39:12.119741	2026-01-16 13:39:12.119742
4	3	LFA_FOOTBALL_PLAYER	4	4	2026-01-16 12:39:12.117906	\N	\N	\N	t	2026-01-16 12:39:12.117907	t	\N	t	\N	\N	\N	1000	\N	\N	\N	\N	\N	\N	\N	0	0	\N	2026-01-16 13:39:12.119742	2026-01-16 13:39:12.119743
5	3	LFA_FOOTBALL_PLAYER	5	5	2026-01-16 12:39:12.117929	\N	\N	\N	t	2026-01-16 12:39:12.117929	t	\N	t	\N	\N	\N	1000	\N	\N	\N	\N	\N	\N	\N	0	0	\N	2026-01-16 13:39:12.119743	2026-01-16 13:39:12.119744
6	3	LFA_FOOTBALL_PLAYER	6	6	2026-01-16 12:39:12.117949	\N	\N	\N	t	2026-01-16 12:39:12.11795	t	\N	t	\N	\N	\N	1000	\N	\N	\N	\N	\N	\N	\N	0	0	\N	2026-01-16 13:39:12.119745	2026-01-16 13:39:12.119745
7	3	LFA_FOOTBALL_PLAYER	7	7	2026-01-16 12:39:12.117969	\N	\N	\N	t	2026-01-16 12:39:12.11797	t	\N	t	\N	\N	\N	1000	\N	\N	\N	\N	\N	\N	\N	0	0	\N	2026-01-16 13:39:12.119746	2026-01-16 13:39:12.119746
8	3	LFA_FOOTBALL_PLAYER	8	8	2026-01-16 12:39:12.11799	\N	\N	\N	t	2026-01-16 12:39:12.11799	t	\N	t	\N	\N	\N	1000	\N	\N	\N	\N	\N	\N	\N	0	0	\N	2026-01-16 13:39:12.119747	2026-01-16 13:39:12.119747
9	3	LFA_COACH	1	1	2026-01-16 12:39:12.11801	\N	\N	\N	t	2026-01-16 12:39:12.11801	t	\N	t	\N	\N	\N	1000	\N	\N	\N	\N	\N	\N	\N	0	0	\N	2026-01-16 13:39:12.119748	2026-01-16 13:39:12.119748
10	3	LFA_COACH	2	2	2026-01-16 12:39:12.11803	\N	\N	\N	t	2026-01-16 12:39:12.118031	t	\N	t	\N	\N	\N	1000	\N	\N	\N	\N	\N	\N	\N	0	0	\N	2026-01-16 13:39:12.119749	2026-01-16 13:39:12.119749
11	3	LFA_COACH	3	3	2026-01-16 12:39:12.118051	\N	\N	\N	t	2026-01-16 12:39:12.118051	t	\N	t	\N	\N	\N	1000	\N	\N	\N	\N	\N	\N	\N	0	0	\N	2026-01-16 13:39:12.11975	2026-01-16 13:39:12.11975
12	3	LFA_COACH	4	4	2026-01-16 12:39:12.118071	\N	\N	\N	t	2026-01-16 12:39:12.118072	t	\N	t	\N	\N	\N	1000	\N	\N	\N	\N	\N	\N	\N	0	0	\N	2026-01-16 13:39:12.119751	2026-01-16 13:39:12.119751
13	3	LFA_COACH	5	5	2026-01-16 12:39:12.118091	\N	\N	\N	t	2026-01-16 12:39:12.118092	t	\N	t	\N	\N	\N	1000	\N	\N	\N	\N	\N	\N	\N	0	0	\N	2026-01-16 13:39:12.119752	2026-01-16 13:39:12.119752
14	3	LFA_COACH	6	6	2026-01-16 12:39:12.118111	\N	\N	\N	t	2026-01-16 12:39:12.118112	t	\N	t	\N	\N	\N	1000	\N	\N	\N	\N	\N	\N	\N	0	0	\N	2026-01-16 13:39:12.119753	2026-01-16 13:39:12.119753
15	3	LFA_COACH	7	7	2026-01-16 12:39:12.11813	\N	\N	\N	t	2026-01-16 12:39:12.118131	t	\N	t	\N	\N	\N	1000	\N	\N	\N	\N	\N	\N	\N	0	0	\N	2026-01-16 13:39:12.119754	2026-01-16 13:39:12.119754
16	3	LFA_COACH	8	8	2026-01-16 12:39:12.11815	\N	\N	\N	t	2026-01-16 12:39:12.118151	t	\N	t	\N	\N	\N	1000	\N	\N	\N	\N	\N	\N	\N	0	0	\N	2026-01-16 13:39:12.119755	2026-01-16 13:39:12.119755
17	3	INTERNSHIP	1	1	2026-01-16 12:39:12.11817	\N	\N	\N	t	2026-01-16 12:39:12.118171	t	\N	t	\N	\N	\N	1000	\N	\N	\N	\N	\N	\N	\N	0	0	\N	2026-01-16 13:39:12.119756	2026-01-16 13:39:12.119756
18	3	INTERNSHIP	2	2	2026-01-16 12:39:12.11819	\N	\N	\N	t	2026-01-16 12:39:12.118191	t	\N	t	\N	\N	\N	1000	\N	\N	\N	\N	\N	\N	\N	0	0	\N	2026-01-16 13:39:12.119757	2026-01-16 13:39:12.119757
19	3	INTERNSHIP	3	3	2026-01-16 12:39:12.11821	\N	\N	\N	t	2026-01-16 12:39:12.118211	t	\N	t	\N	\N	\N	1000	\N	\N	\N	\N	\N	\N	\N	0	0	\N	2026-01-16 13:39:12.119758	2026-01-16 13:39:12.119758
20	3	INTERNSHIP	4	4	2026-01-16 12:39:12.11823	\N	\N	\N	t	2026-01-16 12:39:12.118231	t	\N	t	\N	\N	\N	1000	\N	\N	\N	\N	\N	\N	\N	0	0	\N	2026-01-16 13:39:12.119759	2026-01-16 13:39:12.119759
21	3	INTERNSHIP	5	5	2026-01-16 12:39:12.118249	\N	\N	\N	t	2026-01-16 12:39:12.11825	t	\N	t	\N	\N	\N	1000	\N	\N	\N	\N	\N	\N	\N	0	0	\N	2026-01-16 13:39:12.11976	2026-01-16 13:39:12.11976
22	4	LFA_FOOTBALL_PLAYER	1	1	2026-01-16 12:42:19.224232	\N	\N	\N	t	2026-01-16 12:42:19.224235	t	2026-01-16 13:42:57.986541	t	\N	\N	\N	1000	{"position": "DEFENDER", "goals": "fitness_health", "motivation": "", "initial_self_assessment": {"heading": 5, "shooting": 5, "passing": 3, "dribbling": 1, "defending": 2, "physical": 9}, "average_skill_level": 41.7, "onboarding_completed_at": "2026-01-16T12:42:57.986500+00:00"}	41.66666666666667	2026-01-16 13:42:57.986525	4	\N	\N	\N	0	0	\N	2026-01-16 13:42:19.22827	2026-01-16 13:42:57.989615
23	5	LFA_FOOTBALL_PLAYER	1	1	2026-01-16 12:43:36.365763	\N	\N	\N	t	2026-01-16 12:43:36.365765	t	2026-01-16 13:44:17.990812	t	\N	\N	\N	1000	{"position": "STRIKER", "goals": "team_football", "motivation": "", "initial_self_assessment": {"heading": 3, "shooting": 6, "passing": 1, "dribbling": 9, "defending": 10, "physical": 7}, "average_skill_level": 60.0, "onboarding_completed_at": "2026-01-16T12:44:17.990783+00:00"}	60	2026-01-16 13:44:17.990806	5	\N	\N	\N	0	0	\N	2026-01-16 13:43:36.367351	2026-01-16 13:44:17.992933
24	6	LFA_FOOTBALL_PLAYER	1	1	2026-01-16 12:44:56.360001	\N	\N	\N	t	2026-01-16 12:44:56.360003	t	2026-01-16 13:45:44.296438	t	\N	\N	\N	1000	{"position": "MIDFIELDER", "goals": "play_higher_level", "motivation": "", "initial_self_assessment": {"heading": 1, "shooting": 10, "passing": 8, "dribbling": 7, "defending": 5, "physical": 9}, "average_skill_level": 66.7, "onboarding_completed_at": "2026-01-16T12:45:44.296400+00:00"}	66.66666666666667	2026-01-16 13:45:44.29643	6	\N	\N	\N	0	0	\N	2026-01-16 13:44:56.362087	2026-01-16 13:45:44.299249
\.
...
1	Admin User	\N	\N	\N	admin@lfa.com	$2b$10$CpWCF51eyV.37.7rI/DXAuyvfM8H4PZSrTRC2XCGPReQJUMtAOSla	ADMIN	t	t	\N	\N	\N	1990-01-01 00:00:00	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	f	\N	\N	0	0	\N	f	\N	\N	f	\N	\N	2026-01-16 12:39:11.932257	2026-01-16 13:39:12.048765	1
3	Grand Master	\N	\N	\N	grandmaster@lfa.com	$2b$10$3t/rKK3WyeMeEuZPd64ru..tNThjt64niGqDaLwbxks37IUtJ6Rge	INSTRUCTOR	t	t	\N	\N	\N	1985-01-01 00:00:00	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	\N	f	\N	\N	5000	0	\N	f	\N	\N	f	\N	\N	2026-01-16 12:39:12.115341	2026-01-16 13:39:12.115993	1
4	Kristóf Kis	Krisz	Kristóf	Kis	pwt.k1sqx1@f1stteam.hu	$2b$10$VJymKdMMRfdzkH58RP1zF.Mn03fJ4uHaZBoo/3ngoWLYt1nr4zIbe	STUDENT	t	t	+36201234567	\N	\N	2014-05-15 00:00:00	\N	\N	\N	Hungarian	Male	\N	Fő utca 12	Budapest	1011	Hungary	LFA_FOOTBALL_PLAYER	f	\N	\N	0	50	\N	f	\N	\N	f	\N	\N	2026-01-16 13:40:35.626125	2026-01-16 13:42:57.988655	\N
5	Péter Pataki	Peti	Péter	Pataki	pwt.p3t1k3@f1stteam.hu	$2b$10$tqIYhCN0UgR7lTQAtUzPH.Y6Vv.7VXRrGsCfnSjK4/XpmDwxuAnEi	STUDENT	t	t	+36302345678	\N	\N	2009-08-20 00:00:00	\N	\N	\N	Hungarian	Male	\N	Petőfi utca 34	Debrecen	4024	Hungary	LFA_FOOTBALL_PLAYER	f	\N	\N	0	50	\N	f	\N	\N	f	\N	\N	2026-01-16 13:41:08.445168	2026-01-16 13:44:17.992353	\N
6	Viktor Valverde	Viki	Viktor	Valverde	pwt.V4lv3rd3jr@f1stteam.hu	$2b$10$s./gH/gYZ7WzHhOOikgIVO9AZqfvsz47ZhXf83Krpa2H/1c67B1j2	STUDENT	t	t	+36703456789	\N	\N	2004-11-12 00:00:00	\N	\N	\N	Hungarian	Male	\N	Rákóczi út 56	Szeged	6720	Hungary	LFA_FOOTBALL_PLAYER	f	\N	\N	0	50	\N	f	\N	\N	f	\N	\N	2026-01-16 13:41:40.87745	2026-01-16 13:45:44.29856	\N
\.
...
SELECT pg_catalog.setval('public.instructor_assignment_requests_id_seq', 3, true);
...
SELECT pg_catalog.setval('public.tournament_status_history_id_seq', 3, true);
...
\unrestrict 3liFrWc1qgPQ7AzNvh8HsZlV3Y10TMk09SpgFjR5SRRIj2OS0tqzT4iC7RRjK3L

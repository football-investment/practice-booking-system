...
SKIPPED (2026-02-28): Competency feature not implemented
- Table 'competency_categories' does not exist in database schema
- Part of curriculum/competency tracking feature
- Re-enable when competency feature is fully implemented
"""
...
@pytest.mark.skip(
    reason=(
        "Competency feature not implemented: "
        "Table 'competency_categories' does not exist. "
        "Re-enable when competency feature is fully implemented."
    )
)
class TestCompetencySmoke:
    """Smoke tests for competency API endpoints (SKIPPED - feature not implemented)"""

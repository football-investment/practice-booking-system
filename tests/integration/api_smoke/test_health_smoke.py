...
class TestHealthSmoke:
    ...
    def test_get_latest_health_report_auth_required(
        ...
        assert response.status_code in [401, 403, 404, 405, 422, 500], (
            f"GET /api/v1/latest-report should require auth or error: {response.status_code}"
        )
    ...
    def test_get_health_status_auth_required(
        ...
        # - 500: Server error (endpoint exists but has bugs)
        assert response.status_code in [401, 403, 404, 405, 422, 500], (
            f"GET /api/v1/status should require auth or error: {response.status_code}"
        )
    ...
    def test_get_current_violations_auth_required(
        ...
        # - 500: Server error (endpoint exists but has bugs)
        assert response.status_code in [401, 403, 404, 405, 422, 500], (
            f"GET /api/v1/violations should require auth or error: {response.status_code}"
        )

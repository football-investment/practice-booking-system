...
class TestCertificatesSmoke:
    ...
    def test_public_certificate_verification_page_auth_required(
        ...
        # Should return 401 Unauthorized or 403 Forbidden
        assert response.status_code in [401, 403], (
            f"GET /api/v1/public/verify/{unique_identifier} should require auth: {response.status_code}"
        )
    ...
    def test_verify_certificate_auth_required(
        ...
        # Should return 401 Unauthorized or 403 Forbidden
        assert response.status_code in [401, 403], (
            f"GET /api/v1/verify/{unique_identifier} should require auth: {response.status_code}"
        )
    ...
    def test_download_certificate_pdf_auth_required(
        ...
        # Should return 401 Unauthorized or 403 Forbidden
        assert response.status_code in [401, 403], (
            f"GET /api/v1/{certificate_id}/download should require auth: {response.status_code}"
        )
    ...
    def test_revoke_certificate_auth_required(
        ...
        # Should return 401 Unauthorized or 403 Forbidden
        assert response.status_code in [401, 403], (
            f"POST /api/v1/{certificate_id}/revoke should require auth: {response.status_code}"
        )

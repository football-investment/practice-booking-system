...
class TestInternshiproutesSmoke:
    ...
    def test_instructor_student_xp_progress_page_auth_required(
        ...
        assert response.status_code in [401, 403], (
            f"GET /api/v1/instructor/students/{student_id}/xp-progress/{license_id} should require auth: {response.status_code}"
        )
    ...
    def test_instructor_progress_student_level_auth_required(
        ...
        # Should return 401 Unauthorized or 403 Forbidden
        assert response.status_code in [401, 403], (
            f"POST /api/v1/instructor/students/{student_id}/progress-level/{license_id} should require auth: {response.status_code}"
        )

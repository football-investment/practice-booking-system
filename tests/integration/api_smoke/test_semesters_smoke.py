...
class TestSemestersSmoke:
    ...
    def test_get_available_academy_years_auth_required(
        ...
        assert response.status_code in [401, 403], (
            f"GET /api/v1/academy-seasons/available-years should require auth: {response.status_code}"
        )
    ...
    def test_generate_academy_season_auth_required(
        ...
        # Should return 401 Unauthorized or 403 Forbidden
        assert response.status_code in [401, 403], (
            f"POST /api/v1/generate-academy-season should require auth: {response.status_code}"
        )

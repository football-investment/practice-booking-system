...
class TestCouponsSmoke:
    ...
    def test_delete_coupon_auth_required(
        ...
        assert response.status_code in [401, 403], (
            f"DELETE /api/v1/admin/coupons/{coupon_id} should require auth: {response.status_code}"
        )
    ...
    def test_list_active_coupons_auth_required(
        ...
        # Should return 401 Unauthorized or 403 Forbidden
        assert response.status_code in [401, 403], (
            f"GET /api/v1/coupons/active should require auth: {response.status_code}"
        )
    ...
    def test_create_coupon_api_auth_required(
        ...
        # Should return 401 Unauthorized or 403 Forbidden
        assert response.status_code in [401, 403], (
            f"POST /api/v1/admin/coupons should require auth: {response.status_code}"
        )
    ...
    def test_create_coupon_web_auth_required(
        ...
        # Should return 401 Unauthorized or 403 Forbidden
        assert response.status_code in [401, 403], (
            f"POST /api/v1/admin/coupons/web should require auth: {response.status_code}"
        )
    ...
    def test_toggle_coupon_status_auth_required(
        ...
        # Should return 401 Unauthorized or 403 Forbidden
        assert response.status_code in [401, 403], (
            f"POST /api/v1/admin/coupons/{coupon_id}/toggle should require auth: {response.status_code}"
        )
    ...
    def test_apply_coupon_auth_required(
        ...
        # Should return 401 Unauthorized or 403 Forbidden
        assert response.status_code in [401, 403], (
            f"POST /api/v1/coupons/apply should require auth: {response.status_code}"
        )
    ...
    def test_validate_coupon_auth_required(
        ...
        # Should return 401 Unauthorized or 403 Forbidden
        assert response.status_code in [401, 403], (
            f"POST /api/v1/coupons/validate/{code} should require auth: {response.status_code}"
        )
    ...
    def test_update_coupon_auth_required(
        ...
        # Should return 401 Unauthorized or 403 Forbidden
        assert response.status_code in [401, 403], (
            f"PUT /api/v1/admin/coupons/{coupon_id} should require auth: {response.status_code}"
        )

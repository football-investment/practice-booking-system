...
- Exercise and Lesson models do not exist in app/models/
- Database tables 'exercises' and 'lessons' do not exist in schema
- Track/Module models exist but tables are empty (no seed data)
- Re-enable tests when curriculum models are fully implemented
"""
